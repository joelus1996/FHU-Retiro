...
@Entity
@NamedNativeQuery(name = "RAPITINKASSALE_BETDATA",
				  query = "{call LOTOCARD.RAPITINKASSALE.BET_DATA(?,?)}",
				  callable = true,
				  resultClass = RapitinkasProcedureBetData.class)
public class RapitinkasProcedureBetData implements Serializable {
