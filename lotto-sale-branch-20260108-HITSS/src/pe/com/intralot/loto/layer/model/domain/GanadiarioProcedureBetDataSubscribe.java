...
@Entity
@NamedNativeQuery(
		name="GANADIARIOSALE_BETDATASUBSCRIBE",
		query="{ call LOTOCARD.GANADIARIOSALE.BET_DATA_SUSCRIBE_2(?,?) }",
		callable=true,
		resultClass=GanadiarioProcedureBetDataSubscribe.class
		)
public class GanadiarioProcedureBetDataSubscribe {
