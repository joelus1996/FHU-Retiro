...
@Entity
@NamedNativeQuery(name = "BALANCESALE_GETBALANCELIST", query = "{ call LOTOCARD.BALANCESALE.GETBALANCELIST(?,?) }", callable = true, resultClass = BalanceProcedureGetBalanceList.class)
public class BalanceProcedureGetBalanceList {
