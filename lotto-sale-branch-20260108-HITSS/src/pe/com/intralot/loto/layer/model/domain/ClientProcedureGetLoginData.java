 ...
 * 001   Edgar Narro  	  23/03/2023  login y registro unificado (playerId)
 * </pre>
 * <br></p>
 */
...
public class ClientProcedureGetLoginData implements Serializable {
	...
	public void setMask_phone(Integer mask_phone) {
	...
	public void setRegister_incomplete(Integer register_incomplete) {
		this.register_incomplete = register_incomplete;
	}
