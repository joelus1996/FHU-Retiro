...
@Entity
@NamedNativeQuery(
		name = "DEPORTESVIRTUALESSALE_BETDATA",
		query = "{call LOTOCARD.DEPORTESVIRTUALESSALE.BET_DATA(?,?)}",
		callable = true,
		resultClass = DeportesvirtualesProcedureBetData.class)
public class DeportesvirtualesProcedureBetData implements Serializable{
