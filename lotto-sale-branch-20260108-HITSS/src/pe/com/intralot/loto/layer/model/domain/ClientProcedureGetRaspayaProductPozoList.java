...
@Entity
@NamedNativeQuery(
		name = "CLIENTSALE_GETRASPAYAPRODUCTSPOZO", 
		query = "{ call LOTOCARD.CLIENTSALE.GETRASPAYAPRODUCTSPOZO(?) }", 
		callable = true, 
		resultClass = ClientProcedureGetRaspayaProductPozoList.class
		)

public class ClientProcedureGetRaspayaProductPozoList {
