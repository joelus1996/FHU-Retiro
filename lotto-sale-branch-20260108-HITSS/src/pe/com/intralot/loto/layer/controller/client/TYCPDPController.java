...
/**
 * <p>
 * NOMBRE: TYCPDPController.java
 * <br></p>
 * <p>
 * FUNCION: Controlador de Terminos y condiciones & Politica de privacidad
 * <br></p>
 * <p>
 * NOTAS: Ninguna.
 * <br></p>
 ...
 * VERSIONES
 * <pre>
 * VER   MODIFICADO       FECHA       COMENT
 * 001   Felipe Rodriguez 25/03/2025  First comment
 * </pre>
 * <br></p>
 */
@Controller
public class TYCPDPController {
    ...
    public String modalPopUpTYCPDP(HttpServletRequest request, HttpServletResponse response) throws Exception {
		HttpSession session = request.getSession();
    	session.removeAttribute("PIN_SESSION");
    	return "client/tycpdp_form";
