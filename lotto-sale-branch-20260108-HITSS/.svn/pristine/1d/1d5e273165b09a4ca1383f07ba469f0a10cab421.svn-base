...
@Entity
@NamedNativeQuery(
		name="KABALASALE_BETDATACHCH",
		query="{ call LOTOCARD.KABALASALE.BET_DATA_CHCH_2(?,?) }",
		callable=true,
		resultClass=KabalaProcedureBetDataChCh.class
		)
public class KabalaProcedureBetDataChCh {
