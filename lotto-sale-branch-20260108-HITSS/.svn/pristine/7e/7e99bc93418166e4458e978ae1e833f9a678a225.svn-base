...
var $kabala= function () {
  ...
  //Plus+Chau Chamba
    ...
    */
	...
	var run_cotejo = {toJSON: function (data) {
        ...
        if (status == "ACT") {
            if (total <= 6006 && total >= 1) {
				...
				//https://fbcdn-sphotos-g-a.akamaihd.net/hphotos-ak-frc1/1239908_446330458807068_44489667_n.jpgalert("content_object123:"+content_object);
        ...
        var msgres = new Array();
            ...
            if (content_object.length != 0) {
                ...
                var resultJson="";
				var contador = 0;
                $.ajax({type: "POST", url: "cotejo_tinka_ajax.html", dataType: "text", data: "dato=" + result_ticket,async:false, success: function (e) {
				...
				$.map(resultJson, function (d) { 
    				$.map(d.datos_jugada_A, function (f) { 
                        ...
                        a += '<div class="top-single-game"><div class="row container"><div class="col-6"><h3>RESULTADO :<span>' + f.resultado + '</span></h3></div><div class="col-6"><h3>YAPA: <span>' + f.yapa + '</span></h3></div></div></div>';
    ...
    $('#btn_desktop_contejar_boleto_tinka').on('click',function () {
        if(status == 'ACT'){ 
    ...
    if ((bet1 > 2) && (bet2 < 6) && (bet3 < 6) && (bet4 < 6)) {
        $.map(w, function (e) {
            $.map(e.datos_jugada_A, function (f) {
				...
				a +='<div class="yapa-cotejador-juego">Yapa:  <span class="datos_enunciado_contenido_cotejo_left">'+f.yapa+'</span></div>';
				a += '<div class="datos_separador"><span>......................................................................................................................</span></div>';
        ...
        $.map(w, function (e) {
            $.map(e.datos_jugada_B, function (f) {
                ...
                a += '<span class="datos_enunciado_cotejo_right">Nro de Sorteo:   <span class="datos_enunciado_contenido_cotejo_right">' + f.sorteo + '</span></span><span class="datos_enunciado_cotejo_left">Fecha:  <span class="datos_enunciado_contenido_cotejo_left">' + f.fecha + '</span></span>';
                a += '<div class="datos_separador"><span>......................................................................................................................</span></div>';
                a += '<span class="datos_enunciado_cotejo_right">Resultado del sorteo:   <span class="datos_enunciado_contenido_cotejo_right">'+f.resultado+'</span></span><div class="yapa-cotejador-juego">Yapa:  <span class="datos_enunciado_contenido_cotejo_left">'+f.yapa+'</span></div>';
                a += '<div class="datos_separador"><span>......................................................................................................................</span></div>';
                a += '<div><span class="datos_enunciado_cotejo_right">Jugada A:   <span class="datos_enunciado_contenido_cotejo_right">' + f.jugadaA + '</span></span></div></br>';
                $.map(f.cotejo_jugada_A, function (c) {
                    i++;
