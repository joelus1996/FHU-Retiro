...
@Entity
@NamedNativeQuery(
		name="KABALASALE_BETDATASUBSCRIBE",
		query="{ call LOTOCARD.KABALASALE.BET_DATA_SUSCRIBE_2(?,?) }",
		callable=true,
		resultClass=KabalaProcedureBetDataSubscribe.class
		)
public class KabalaProcedureBetDataSubscribe {
