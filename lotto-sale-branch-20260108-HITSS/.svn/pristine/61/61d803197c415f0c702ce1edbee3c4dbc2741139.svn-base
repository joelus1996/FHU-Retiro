...
<link media="screen" rel="stylesheet" type="text/css"
	href="layer-view-style/game/tinka/themeCotejador.css" />
<link media="screen" rel="stylesheet" type="text/css"
	href="layer-view-style/game/tinka/themeTinka.css" />
<link media="screen" rel="stylesheet" type="text/css"
...
<script type="text/javascript"
	...
	<style>
		...
		.main-play .body-play .wrapper-playing .current-games .boxes-current-games .box-current-game.game-playing a, .main-play .body-play .wrapper-playing .current-games .boxes-current-games .box-current-game:hover a {
	    	color: #fff;
...
<div class="row cotenedor_tinka_cotejador">
		<div class="col-12 col-md-8">
			<div class="main-panel">
				<div class="main-play modal-coteja-boleto" style="width: 613px">
					<div class="body-play">
						<div class="logo_tinka_cotejador" id="tinka-cotejo-logo">
							<img src="layer-view-image/game/tinka/premios-logo-tinka.jpg?v=1"
								title="Tinka" alt="Tinka"> <h2>Coteja tu tinka y entérate si ganaste un premio</h2>
						</div>						
																		...
																		<div class="button-group checkboxes-ball clearfix">
																			...
																			<div class="margin">
																				<input type="checkbox" name="check" id="J1check_31" value="31"
																					...
																					id="LJ1check_35" class="check_">35</label> <input
																					type="checkbox" name="check" id="J1check_36" value="36"
																					class="J1check_36" /><label for="J1check_36"
																					id="LJ1check_36" class="check_">36</label>
																			</div>
																			<div class="margin">
																				<input type="checkbox" name="check" id="J1check_37" value="37"
																					class="J1check_37" /><label for="J1check_37"
																					id="LJ1check_37" class="check_">37</label> <input
																					type="checkbox" name="check" id="J1check_38" value="38"
																					class="J1check_38" /><label for="J1check_38"
																					id="LJ1check_38" class="check_">38</label> <input
																					type="checkbox" name="check" id="J1check_39" value="39"
																					class="J1check_39" /><label for="J1check_39"
																					id="LJ1check_39" class="check_">39</label> <input
																					type="checkbox" name="check" id="J1check_40" value="40"
																					class="J1check_40" /><label for="J1check_40"
																					id="LJ1check_40" class="check_">40</label>
																					<input type="checkbox" name="check" id="J1check_41" value="41"
																					class="J1check_41" /><label for="J1check_41"
																					id="LJ1check_41" class="check_">41</label> <input
																					type="checkbox" name="check" id="J1check_42" value="42"
																					class="J1check_42" /><label for="J1check_42"
																					id="LJ1check_42" class="check_">42</label>
																			</div>
																			<div class="margin">
																				    <input type="checkbox" name="check" id="J1check_43" value="43"
																				    class="J1check_43" />
																					<label for="J1check_43" id="LJ1check_43" class="check_">43</label> 
																					
																					<input type="checkbox" name="check" id="J1check_44" value="44"class="J1check_44" />
																					<label for="J1check_44"id="LJ1check_44" class="check_">44</label>
																					
																					<input type="checkbox" name="check" id="J1check_45" value="45"class="J1check_45" />
																					<label for="J1check_45" id="LJ1check_45" class="check_">45</label>
																					
																					<input type="checkbox" name="check" id="J1check_46" value="46"class="J1check_46" />
																					<label for="J1check_46" id="LJ1check_46" class="check_">46</label>
																					
																					<input type="checkbox" name="check" id="J1check_47" value="47"class="J1check_47" />
																					<label for="J1check_47" id="LJ1check_47" class="check_">47</label>
																					
																					<input type="checkbox" name="check" id="J1check_48" value="48"class="J1check_48" />
																					<label for="J1check_48" id="LJ1check_48" class="check_">48</label>		
																			</div>																					
																			<div class="margin">
																					<input type="checkbox" name="check" id="J1check_49" value="49"class="J1check_49" />
																					<label for="J1check_49" id="LJ1check_49" class="check_">49</label>
																					
																					<input type="checkbox" name="check" id="J1check_50" value="50"class="J1check_50" />
																					<label for="J1check_50" id="LJ1check_50" class="check_">50</label>
																			</div>
																		</div>
																	</div>
																</div>
																		...
																		<div class="button-group checkboxes-ball clearfix">
																			...
																			<div class="margin">
																				<input class="J2check_31" value="31" id="J2check_31"
																					...
																					type="checkbox"><label class="check_"
																					id="LJ2check_35" for="J2check_35">35</label> <input
																					class="J2check_36" value="36" id="J2check_36" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ2check_36" for="J2check_36">36</label>
																			</div>
																			<div class="margin">
																				<input class="J2check_37" value="37" id="J2check_37"
																					name="check" type="checkbox"><label class="check_"
																					id="LJ2check_37" for="J2check_37">37</label> 
																				<input class="J2check_38" value="38" id="J2check_38" 
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_38" for="J2check_38">38</label> 
																				<input class="J2check_39" value="39" id="J2check_39"
																					name="check" type="checkbox"><label class="check_"
																					id="LJ2check_39" for="J2check_39">39</label> 
																				<input class="J2check_40" value="40" id="J2check_40"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_40" for="J2check_40">40</label>
																				<input class="J2check_41" value="41" id="J2check_41" 
																					name="check" type="checkbox"><label class="check_"
																					id="LJ2check_41" for="J2check_41">41</label>
																				<input class="J2check_42" value="42" id="J2check_42" 
																					name="check" type="checkbox"><label class="check_"
																					id="LJ2check_42" for="J2check_42">42</label>	
																			</div>							
																			<div class="margin">
																				<input class="J2check_43" value="43" id="J2check_43"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_43" for="J2check_43">43</label>
																				<input class="J2check_44" value="44" id="J2check_44"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_44" for="J2check_44">44</label>
																				<input class="J2check_45" value="45" id="J2check_45"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_45" for="J2check_45">45</label>
																				<input class="J2check_46" value="46" id="J2check_46"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_46" for="J2check_46">46</label>
																				<input class="J2check_47" value="47" id="J2check_47"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_47" for="J2check_47">47</label>
																				<input class="J2check_48" value="48" id="J2check_48"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_48" for="J2check_48">48</label>
																			</div>
																			<div class="margin">
																					<input class="J2check_49" value="49" id="J2check_49"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_49" for="J2check_49">49</label>
																				<input class="J2check_50" value="50" id="J2check_50"
																					name="check"type="checkbox"><label class="check_"
																					id="LJ2check_50" for="J2check_50">50</label>
																			</div>
																		</div>
																	</div>
																</div>
																		...
																		<div class="button-group checkboxes-ball clearfix">
																			...
																			<div class="margin">
																				<input class="J3check_31" value="31" id="J3check_31"
																					...
																					type="checkbox"><label class="check_"
																					id="LJ3check_35" for="J3check_35">35</label> <input
																					class="J3check_36" value="36" id="J3check_36" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_36" for="J3check_36">36</label>
																			</div>
																			<div class="margin">
																				<input class="J3check_37" value="37" id="J3check_37"
																					name="check" type="checkbox"><label class="check_"
																					id="LJ3check_37" for="J3check_37">37</label> <input
																					class="J3check_38" value="38" id="J3check_38" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_38" for="J3check_38">38</label> <input
																					class="J3check_39" value="39" id="J3check_39" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_39" for="J3check_39">39</label> <input
																					class="J3check_40" value="40" id="J3check_40" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_40" for="J3check_40">40</label>
																					<input
																					class="J3check_41" value="41" id="J3check_41" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_41" for="J3check_41">41</label>
																					<input
																					class="J3check_42" value="42" id="J3check_42" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_42" for="J3check_42">42</label>
																			</div>
																			<div class="margin">
																					<input
																					class="J3check_43" value="43" id="J3check_43" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_43" for="J3check_43">43</label>
																					<input
																					class="J3check_44" value="44" id="J3check_44" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_44" for="J3check_44">44</label>
																					<input
																					class="J3check_45" value="45" id="J3check_45" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_45" for="J3check_45">45</label>
																					<input
																					class="J3check_46" value="46" id="J3check_46" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_46" for="J3check_46">46</label>
																					<input
																					class="J3check_47" value="47" id="J3check_47" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_47" for="J3check_47">47</label>
																					<input
																					class="J3check_48" value="47" id="J3check_48" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_48" for="J3check_48">48</label>
																					
																			</div>	
																			<div class="margin">
																					<input
																					class="J3check_49" value="49" id="J3check_49" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_49" for="J3check_49">49</label>
																					<input
																					class="J3check_50" value="50" id="J3check_50" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ3check_50" for="J3check_50">50</label>
																			</div>
																	...
																	<div class="body-game">
																		<div class="button-group checkboxes-ball clearfix">
																			...
																			<div class="margin">
																					...
																					type="checkbox"><label class="check_"
																					id="LJ4check_35" for="J4check_35">35</label> <input
																					class="J4check_36" value="36" id="J4check_36" name="check"
																					type="checkbox"><label class="check_"
																					id="LJ4check_36" for="J4check_36">36</label>
																			</div>
																			<div class="margin">
																				<input class="J4check_37" value="37" id="J4check_37"
																				name="check" type="checkbox"><label class="check_"
																				id="LJ4check_37" for="J4check_37">37</label> <input
																				class="J4check_38" value="38" id="J4check_38" name="check"
																				type="checkbox"><label class="check_" id="LJ4check_38"
																				for="J4check_38">38</label> <input class="J4check_39"
																				value="39" id="J4check_39" name="check" type="checkbox"><label
																				class="check_" id="LJ4check_39" for="J4check_39">39</label> <input
																				class="J4check_40" value="40" id="J4check_40" name="check"
																				type="checkbox"><label class="check_" id="LJ4check_40"
																				for="J4check_40">40</label>
																				<input
																				class="J4check_41" value="41" id="J4check_41" name="check"
																				type="checkbox"><label class="check_" id="LJ4check_41"
																				for="J4check_41">41</label>
																				<input
																				class="J4check_42" value="42" id="J4check_42" name="check"
																				type="checkbox"><label class="check_" id="LJ4check_42"
																				for="J4check_42">42</label>
																			</div>
																			<div class="margin">
																					<input
																					class="J4check_43" value="43" id="J4check_43" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_43"
																					for="J4check_43">43</label>
																					<input
																					class="J4check_44" value="44" id="J4check_44" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_44"
																					for="J4check_44">44</label>
																					<input
																					class="J4check_45" value="45" id="J4check_45" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_45"
																					for="J4check_45">45</label>
																					<input
																					class="J4check_46" value="46" id="J4check_46" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_46"
																					for="J4check_46">46</label>
																					<input
																					class="J4check_47" value="47" id="J4check_47" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_47"
																					for="J4check_47">47</label>
																					<input
																					class="J4check_48" value="48" id="J4check_48" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_48"
																					for="J4check_48">48</label>
																			</div>
																			<div class="margin">
																					<input
																					class="J4check_49" value="49" id="J4check_49" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_49"
																					for="J4check_49">49</label>
																					<input
																					class="J4check_50" value="50" id="J4check_50" name="check"
																					type="checkbox"><label class="check_" id="LJ4check_50"
																					for="J4check_50">50</label>
																			</div>
																		</div>
																	</div>
																</div>
													...
													<div class="box-content-game">
														...
														<div class="current-game-detail">
															<div class="row">
																...
																<div class="col-4">
																	<div class="selectBox">				   		
																		<c:forEach items="${TinkaValoresBoleto}" var="num" begin="0" end="0">
																		<div class="box" id="box">${num}</div> 
																		</c:forEach>
															   		
																		<select  name="model" id="mySelectBox" 
																		onChange="valChange(this);">
																		<c:forEach items="${TinkaValoresBoleto}" var="cantBoleto" >
																...
																<div class="row">
																	...
																	<div class="col-9">
																		<div class="selectBox">
																		   ...
																		   <div class="box" id="box-2">${tinkaSaleList.id.drawId} el ${tinkaSaleList.drCloseDate}</div> 
																		   </c:forEach>
																   		
																			<select  name="model" id="mySelectBox-2" onChange="valChange(this);">
																			<c:forEach items="${tinkaSaleList}" var="tinkaSaleList" >
																				<option value="${tinkaSaleList.id.drawId}">${tinkaSaleList.id.drawId} el ${tinkaSaleList.drCloseDate}</option>
																			</c:forEach>
																			</select>	
																		</div>
																	</div>
																		...
																		<div class="selectBox">
																			<div class="fechaCant">
																				<div class="checkcotent">
																					 <c:forEach items="${tinkaSaleList}" var="tinkaSaleList" begin="0" end="0">
																				     <span id="fechaCotejo" >${tinkaSaleList.id.drawId}</span>
																				     </c:forEach>
																				</div>
																			</div>
																		</div>
...
<!-- 																<button id="buy" type="button" onclick="return false;" class="button button-lg button-no-shadow button-block button-orange"><b>COTEJAR</b></button> -->
																<button id="btn_desktop_contejar_boleto_tinka" type="button" onclick="return false;" class="button button-lg button-no-shadow button-block button-orange"><b>COTEJAR</b></button>
															</div>
					...
					<div id="cotejoKabala"">
						...
						<div id="movefoot" class="footer-single-game" style="display:none"><div><div class="action-buy volver-a-cotejar"><button id="more_plays" type="button" class="button button-lg button-no-shadow button-block button-orange button-green-new"><b>REGRESAR</b></button><button onclick="datalayerJuegaAqui();window.parent.location.href='juega-tinka.html'" type="button" class="button button-lg button-no-shadow button-block button-red-juega button-red-new"><b>JUEGA AQU&Iacute;</b></button></div>
					</div>
				</div>
			</div>
		</div>
...
<script type='text/javascript' src='layer-view-script/common/jquery-3.6.3.min.js'></script>
	...
	<script type='text/javascript'
		src='layer-view-script/game/tinka/lotto-tinka-cotejador.js?v=5'></script>
	<script type="text/javascript"
