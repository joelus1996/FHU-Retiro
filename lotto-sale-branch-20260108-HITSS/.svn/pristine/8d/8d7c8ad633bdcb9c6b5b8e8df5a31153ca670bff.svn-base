    ...
    $("#finalize").click(function () {
        if(!$(this).hasClass("btn-disabled")) {
            ...
            if (content_object.length != 0) {
                var content_grid_2 = "<div class='label-top'></div>" + "<div class='label_1'>K&Aacute;BALA</div>" + "<div id='ajax-loader'>" + "<img src='layer-view-image/game/ganadiario/ajax-loader.gif'>" + "</div><div id='content-grid-result'></div>" + "<div id='num_link'></div>" + "<div id='game-no-process-info'></div>";
                ...
                $("#ajax-loader").show();
                var contador = 0;
                $.ajax({type: "POST", url: "pago_premio.html", data: "dato=" + result_ticket + "&desist=" + sdesist + "&credit=" + scredit + "&game=42", dataType: "text", success: function (e) {
                    var fila = e.split("#");
                    var mensaje = "";
