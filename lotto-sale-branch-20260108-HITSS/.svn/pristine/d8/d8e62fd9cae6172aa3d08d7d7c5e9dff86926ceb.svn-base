...
<script type="text/javascript" src="layer-view-script/common/prefixfree.min.js"></script>
    ...
    <title>Restablecer Usuario - La Tinka</title>
                        ...
                        <div id="send" style="display: block">
                            ...
                            <form id="frm-user-reminder" action="send_user_mail.html" method="post">
                                ...
                                <div class="head-main-form">
                                    <h2>RECUERDA TU USUARIO</h2>
                                    <div class="sub-head-form">
                                        <p class="no-upper"><span style="font-size: 15.4px;font-family: Roboto, sans-serif;">Confírmanos tu tipo y número de documento, enviaremos a tu correo registrado tu usuario.</span></p>
                                    </div>
                                </div>
