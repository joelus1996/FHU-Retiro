...
<div class="datos datos-por-bolilla">
	<div class="col col-margen">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<th align="left" colspan="3">
					<div class="tabla-cabecera">
						<div class="titulo1">Bolilla</div>
			...
			<tr class="tabla-fila">
				<td width="40"><div class="celdai celda-bolilla">${element.number}</div></td>
				<td width="106">
				...
				<td width="54">
					<div class="celdad celda-numero">${element.count}</div>
				</td>
			</tr>
			</c:forEach>
		</table>
