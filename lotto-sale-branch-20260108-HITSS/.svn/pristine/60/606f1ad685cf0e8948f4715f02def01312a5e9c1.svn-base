...
<!-- End Google Tag Manager (noscript) -->
						...
						<div class="activate__content">
							...
							<div class="step step-02 hide">
								...
								<form class="form" id="form_resend" autocomplete="off">
									...
									<p class="activate__disclaimer_text">
									...
									<div class="form__button-stack">
										<button class="button button__base_4" type="submit"
											id="btresendwa" disabled>WHATSAPP</button>
										<button class="button button__base_4" type="submit"
											id="btresend" disabled>SMS</button>
									</div>
								</form>
							</div>
							<!-- step 03-->
							...
							<p>&nbsp;</p>
							<p>&nbsp;</p>
								<h3 class="activate__title c_green">¡Felicitaciones!<br />[name]!</h3>
								
								<div class="box_message">
									<h4>Bienvenido a la tinka </h4>
									<p class="activate__text">Estas a un clic de ser millonario.<br>
									Realiza tu primera recarga.</p>
									
									<div class="form"> 
									 <div class="form__button">
										<c:if test="${OperatorId ne 5588}">
											<a class="button button__outline" href="#" id="lnkCargarSaldo"  data-name="Evaluate - Activa cuenta" data-category="Activacion-Evaluate" data-action="click" data-label="Activa cuenta - cargar saldo">Cargar Saldo</a><br><br>
											<a class="button button__base" href="#" id="lnkMiCuenta" data-name="Evaluate - Activa cuenta" data-category="Activacion-Evaluate" data-action="click" data-label="Activa cuenta - ir a mi cuenta">Continuar</a>
										</c:if>
										<c:if test="${OperatorId eq 5588}">
											<a class="button button__outline" href="#" id="lnkCargarSaldoTA"  data-name="Evaluate - Activa cuenta" data-category="Activacion-Evaluate" data-action="click" data-label="Activa cuenta - cargar saldo">Cargar Saldo</a><br><br>
											<a class="button button__base" href="#" id="lnkMiCuenta" data-name="Evaluate - Activa cuenta" data-category="Activacion-Evaluate" data-action="click" data-label="Activa cuenta - ir a mi cuenta">Continuar</a>
										</c:if>
									 </div>
								   </div>
	...
	<script type="text/javascript">		
		$(document).ready(function() {
			...
			$('#btresend').on('click', function(e) {
			    datalayerSendSMS();
			  });
			  
			$('#btresendwa').on('click', function(e) {
