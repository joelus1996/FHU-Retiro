var $cotejoKabala = function () {
	...
	var run = {
			...
			var w = run.toJSON($('#jugadaCompletaKabala').val());
			var bet1 ='';
			var bet2 ='';
			var bet3 ='';
			var bet4 ='';
			...
			$.map(w,function(k){
				$.map(k.resultado_jugada, function (t) {
						...
						a+='<span class="mensaje_kabala" Style="margin-top="4px";">*Todos los premios estan sujetos a impuestos y a retenciones de Ley(10%),excepto los premios menores </span><br/>';
						a+='<span class="mensaje_kabala" Style="margin-top="4px";">o iguales a S/.20.00.</span>';
						a+='<div style="margin: 10px;"></div>';
				});
				});
				$("#valor").html(a);
