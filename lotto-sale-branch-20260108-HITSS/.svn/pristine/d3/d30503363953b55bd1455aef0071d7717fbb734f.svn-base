...
@Entity
@NamedNativeQuery(
		name = "GANAGOLSALE_PROGRAMDATA", 
		query = "{ call LOTOCARD.GANAGOLSALE.PROGRAM_DATA(?,?) }", 		
		callable = true, 
		resultClass = GanagolProcedureProgramData.class)
public class GanagolProcedureProgramData {
	@Id
	@Column(name = "w_item")
