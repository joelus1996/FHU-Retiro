...
@Entity
@NamedNativeQuery(
		name="TINKASALE_BETDATA",
		query="{ call LOTOCARD.TINKASALE.BET_DATA_2(?,?) }",
		callable=true,
		resultClass=TinkaProcedureBetData.class
		)
public class TinkaProcedureBetData {
	...
	@Transient
	private int simpleBetPriceInt;
	
	@Transient
	private boolean flagPromotionMessage;
	...
	public int getSimpleBetPriceInt() {
		return simpleBetPriceInt;
	}
	
	public void setSimpleBetPriceInt(int simpleBetPriceInt) {
		this.simpleBetPriceInt = simpleBetPriceInt;
	}

	public boolean isFlagPromotionMessage() {
		return flagPromotionMessage;
	}

	public void setFlagPromotionMessage(boolean flagPromotionMessage) {
		this.flagPromotionMessage = flagPromotionMessage;
	}
