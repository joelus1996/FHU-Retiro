...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="main-content" style="top: 0px;padding-top: 0px;">   																							
		<div class="main-game promSorteo" style="background-color: #d7e2e4;">
			<img src="layer-view-image/game/virtuales/juegaGanaConVirtuales/Banner-header-desktop.png" alt="Juega Deportes Virtuales" style="width: 100%;">
			<h2 style="color: #e16e1a;">Tus jugadas desde S/ 5 realizadas </h2>
			<h2 style="color: #e16e1a;">en la WEB</h2>
			<h3 style="color: #000000;">¡Participan automáticamente!</h3>
			<div class="copa-opciones2">													
				<button style="width: 179px;padding: 5px 5px 5px 5px;margin-top:0px" type="button" id="btnJuegaddvvResultados" onclick="return false;"class="button-juegaddvv-naranja" >Ver mis jugadas</button>
			</div>
			<div class="copa-opciones2">													
				<button style="width: 179px;padding: 5px 5px 5px 5px;" type="button" id="btnJuegaddvvComoParticipar" onclick="return false;"class="button-juegaddvv-blanco" >Términos y condiciones</button>											
			</div>	 
