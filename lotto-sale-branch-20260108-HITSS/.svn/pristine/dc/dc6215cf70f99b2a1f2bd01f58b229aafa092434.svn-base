...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="main-content" style="top: 0px;padding-top: 0px;">													
					<div class="main-game copa-casa" style="background-color: #d7e2e4;">
						<img src="${rutaAvionPeru}/home-desktop-peru.png?v=4" alt="Avión del Hincha Eliminatorias 2026." style="width: 100%;">
						<h2 style="color: #f75b1e;">Participa con tus jugadas desde S/ 10</h2>
						<h3 style="color: #000000;">¿Quieres participar en la promoción?</h3>				
						<div class="copa-opciones2">
							<button style="width: 179px;" type="button" id="${btnRegistrar}" onclick="return false;"class="button-avion-qatar-naranja" >Sí quiero</button>
						</div>			
						<div class="f_linea-copabicolor2"></div>
						<div class="copa-opciones2">
							<button style="width: 179px;" type="button" id="${btnComoParticipar}" onclick="return false;"class="button-avion-qatar-blanco">¿Cómo participar?</button>																																	
						</div>																																	
						<div class="copa-descripcion">
							<h3 style="color: #000000;">Del ${fechaPromo}</h3>
						</div>
					</div>														
    </div>
