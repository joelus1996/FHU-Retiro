...
@Entity
@NamedNativeQueries({
		@NamedNativeQuery(name = "TICKETSALE_GETTICKETSLIST", query = "{ call LOTOCARD.TICKETSALE.GETTICKETSLIST(?,?) }", callable = true, resultClass = TicketProcedureGetTicketsList.class),
		@NamedNativeQuery(name = "TICKETRETAIL_GETTICKETSLIST", query = "{ call RETAIL.CLIENTPRO.GETTICKETSLIST(?,?) }", callable = true, resultClass = TicketProcedureGetTicketsList.class)
})
public class TicketProcedureGetTicketsList {
