...
@Entity
@NamedNativeQuery(
		name="GANADIARIOSALE_BETDATA",
		query="{ call LOTOCARD.GANADIARIOSALE.BET_DATA_2(?,?) }",
		callable=true,
		resultClass=GanadiarioProcedureBetData.class
		)
public class GanadiarioProcedureBetData {
	...
	public void setNumbersMore(String numberMore) {
		this.numbersMore = numberMore;
	}
