...
<!-- End Google Tag Manager -->
    ...
    <meta charset="utf-8">
    <meta name="description" content="Juega en línea la única lotería que se sortea todos los días cien mil soles (S/.100,000) en el Perú. ¡Juega Gana Diario y mejora tu vida hoy!">
    ...
    <title>Juega Gana Diario y gana un Premio de S/ 100,000 soles.</title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <input type="hidden" value="${ganadiarioSale.numbersMore}" id="more_repeated">
    <input type="hidden" value="${ganadiarioSale.numbersLess}" id="less_repeated">
    <input type="hidden" value="${ganadiarioSale.status}" id="status">
    <input type="hidden" value="${ganadiarioSale.simpleBetPrice}" id="simpleBetPrice_repeated">
    <input type="hidden" value="${ganadiarioSale.promotionType}" id="promo">
    <input type="hidden" value="${ganadiarioSale.priceType}" id="price_type">
    <input type="hidden" value="${ganadiarioSale.algorithm}" id="algorithm">
    <input type="hidden" value="${ganadiarioSale.bets}" id="bets">
    <input type="hidden" value="${ganadiarioSale.pay}" id="pay">
    <input type="hidden" value="${ganadiarioSale.cost}" id="cost">
    <input type="hidden" value="${ganadiarioSale.draws}" id="draw">
    <input type="hidden" value="${ganadiarioSale.balanceAmountGame}" id="balanceAmountGame">
          ...
          <div class="row">
            <div class="col-12 col-md-8">
              <div class="box-main-game top-box">
                <div class="top-banner top-ganadiario">
                  <figure>
                  ...
                  <div class="body-banner">
                    <div class="left-banner">
                      <div class="banner-price">
                        ...
                        <h3 data-text="S/ ${ganadiarioSale.prize}">S/ ${ganadiarioSale.prize}</h3>
                      </div>
                    </div>
                    <div class="right-banner">
                      <div class="banner-desc">
<!--                         <p>Juégalo HOY</p> -->
<%--                         <p>hasta ${ganadiarioSale.closeHour}</p> --%>
              ...
              <div class="main-panel">
                <div class="main-play">
                  ...
                  <div class="body-play">
                    <div class="play-help">
                      <a href="<%=Constants.URL_QW%>/tutorial/como-jugar-gana-diario/" target="_blank" class="play-text"><span>?</span> Ayuda</a>
                    </div>
                                ...
                                <div class="box-wrapper-game box-content-left">
                                  <div class="box-content-game">
                                    <div class="box-play-main box-play-a">
                                      <div class="content-single-game">
                                        <div class="top-single-game">
                                          <h3>JUGADA A <span>Marca 5 bolillas</span></h3>
                                        </div>
                                    ...
                                    <div class="box-play-main box-play-b" style="display: none">
                                      <div class="content-single-game">
                                        <div class="top-single-game">
                                          <h3>JUGADA B <span>Marca 5 bolillas</span></h3>
                                        </div>
                                        <div class="body-single-game">
                                          <div class="body-game">
                                            <div class="button-group checkboxes-ball clearfix">
                                    ...
                                    <div class="box-play-main box-play-c" style="display: none">
                                      <div class="content-single-game">
                                        <div class="top-single-game">
                                          <h3>JUGADA C <span>Marca 5 bolillas</span></h3>
                                        </div>
                                        <div class="body-single-game">
                                          <div class="body-game">
                                            <div class="button-group checkboxes-ball clearfix">
                                    ...
                                    <div class="box-play-main box-play-d" style="display: none">
                                      <div class="content-single-game">
                                        <div class="top-single-game">
                                          <h3>JUGADA D <span>Marca 5 bolillas</span></h3>
                                        </div>
                                        <div class="body-single-game">
                                          <div class="body-game">
                                            <div class="button-group checkboxes-ball clearfix">
                              ...
                              <div class="col-6">
                                ...
                                <div class="box-action-pay">
                                  <div id="panel_keep-playing">
                                    <a href="juega-ganadiario.html" id="keep-playing" class="button button-lg button-no-shadow button-block button-orange">
                                    <b>SEGUIR JUGANDO</b>
                                    </a>
                                  </div>
                  ...
                  <div class="box-banner">
                    <div class="box-main-game">
                      <div class="box-main-desc">
                        ...
                        <div class="main-desc-slogan">¡Mejora tu vida hoy!</div>
                      </div>
                    </div>
                  </div>
                  <div class="box-banner">
    ...
    <script type='text/javascript' src='layer-view-script/game/ganadiario/lotto-award-ganadiario.js'></script>
