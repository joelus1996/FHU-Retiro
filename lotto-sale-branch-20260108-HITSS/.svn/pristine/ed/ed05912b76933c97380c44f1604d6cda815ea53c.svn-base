...
public class SmsProviderUtils {
    ...
    public String generateRandomCode() {
    	...
    	int randomCode;
    	int size = Integer.parseInt(ConnectionFactory.operationProperty("smsCodeSize", Constants.contextSale).toString());
    ...
    public SmsResultBean sendNetSMS(String mobile, String message) {
    	...
    	try {
    		String urlStr = ConnectionFactory.operationProperty("smsUrlProvider", Constants.contextSale);
    		String user = ConnectionFactory.operationProperty("smsParamUsername", Constants.contextSale);
    		String password = ConnectionFactory.operationProperty("smsParamPassword", Constants.contextSale);
    ...
    public SmsResultBean sendNetWa(String mobile, String message) {
    	SmsResultBean result = new SmsResultBean();
    	try {
    		String urlStr = ConnectionFactory.operationProperty("waUrlProvider", Constants.contextSale);
    		String user = ConnectionFactory.operationProperty("smsParamUsername", Constants.contextSale);
    		String password = ConnectionFactory.operationProperty("smsParamPassword", Constants.contextSale);
			URL url = new URL(urlStr+mobile+"/"+URLEncoder.encode(message,"UTF-8"));
			HttpURLConnection conn = (HttpURLConnection)url.openConnection();
