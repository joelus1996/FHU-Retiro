		...
		$.ajax({
            ...
            success: function (e) {
            	...
            	if(url != "-" && url != "" && url != "sinSesion"){
        			$('body').append('<div id="div-lightbox-recharge-ilot" style="position: fixed;top: 0;left: 0;right: 0;bottom: 0;z-index: 2147483000;overflow: auto;"><button id="lightbox-recharge-ilot-close" onclick="closeLightboxRechargeIlotF();" class="lightbox-recharge-ilot-close" ></button><iframe id="frmLightboxRecharge" scrolling="no" frameborder="0" onload="retirar_loading();" src="open-casino.html?url=' + url + '" class="lightbox-recharge" ></iframe></div>');
