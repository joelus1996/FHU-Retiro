...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="main-content" style="top: 0px;padding-top: 0px;">   																							
					<div class="main-game copa-casa">
						<img src="layer-view-image/game/copaentucasa/img-copa-en-tu-casa-desktop.gif" style="width: 100%;">
						<h2>Gana una TV Ultra HD 70",</h2>
						<h3>soundbar, Kit Blanquirrojo y frigobar.</h3>
						<h3>Además, miles de soles en saldos y premios.</h3>
						<span class="juega-5">Juega desde S/5</span>	
										
						<div class="copa-opciones">													
							<button type="button" id="btn_desktop_como_participar_copa" onclick="return false;"class="button-copa1">¿Cómo participar?</button>																												
							<button type="button" id="btn_desktop_ver_mis_jugadas" onclick="return false;"class="button-copa2">Ver mis jugadas</button>												
						</div>					
