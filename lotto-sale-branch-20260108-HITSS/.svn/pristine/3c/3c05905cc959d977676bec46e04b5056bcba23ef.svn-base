			...
			<div class="content">				
				<section class="main-section">														
					<div class="main-game copa-casa-results" style="background-color: #d7e2e4;padding-bottom: 65px;">
						<div class="avionQatar-volver" style="background-color: #d7e2e4;">
							  <div class="row">
					...
					<div class="f_linea-copacasa" ></div>	 
					 <div class="row" style="width: 950px;margin: 0px;">	
						...
						<div class="desc-sorteo" ><h3 style="color: #000000">SORTEOS 24 DE OCTUBRE Y 21 DE NOVIEMBRE:</h3></div>
						<div class="desc-premio" ><h3 style="color: #f75b1e;margin-left: 30px; margin-right: -30px;">¡10 GANADORES DE UN PAQUETE PARA IR A LA FINAL EN QATAR!</h3></div>	
					...
					<div class="col-sm-6">
						...
						<div class="desc-premio" ><h3 style="font-size:15px; color: #f75b1e;">¡Son S/ 110,000 en saldos para seguir jugando!</h3></div>												
