...
@Entity
@NamedNativeQuery(
		name="GANADIARIOSALE_DRAWDATA",
		query="{ call LOTOCARD.GANADIARIOSALE.DRAW_DATA(?) }",
		callable=true,
		resultClass=GanadiarioProcedureDrawData.class
		)
public class GanadiarioProcedureDrawData {
