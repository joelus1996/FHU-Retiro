...
function changeStyle(p) {
	...
	if(p=="inicio" || p=="micuenta" || p=="contactenos") {
		...
		top.document.getElementById("cjugar").innerHTML="<a href='https://latinkaportal.com.pe/tutoriales/' target='_blank'>Aprende a Jugar</a>";
		top.document.getElementById("psuerte").innerHTML="<a href='https://latinkaportal.com.pe/puntos-de-venta/' target='_blank'>Puntos de la Suerte</a>";
		...
		top.document.getElementById("logo").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank' title='Super 3'></a>";
		top.document.getElementById("cjugar").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank' title='Intralot'>Aprende a Jugar</a>";
		top.document.getElementById("psuerte").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank'>Puntos de la Suerte</a>";
		top.document.getElementById("ajugar").innerHTML="<a href='#' onclick='dhtmlwindow.open(\"prizebox\",\"inline\",\"<object style=height:344px;width:425px>" +
		...
		top.document.getElementById("logo").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank' title='Revent�n'></a>";
		top.document.getElementById("cjugar").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank' title='Intralot'>Aprende a Jugar</a>";
		top.document.getElementById("psuerte").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank'>Puntos de la Suerte</a>";
		top.document.getElementById("ajugar").innerHTML="<a href='#' onclick='dhtmlwindow.open(\"prizebox\",\"inline\",\"<object style=height:344px;width:425px>" +
		...
		top.document.getElementById("logo").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank' title='Rapitinkas y Rapigana'></a>";
		top.document.getElementById("cjugar").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank' title='Intralot'>Aprende a Jugar</a>";
		top.document.getElementById("psuerte").innerHTML="<a href='https://latinkaportal.com.pe/' target='_blank'>Puntos de la Suerte</a>";
		top.document.getElementById("ajugar").innerHTML="<a href='#' onclick='dhtmlwindow.open(\"prizebox\",\"inline\",\"<object style=height:344px;width:425px>" +
...
function toRegister() {
	...
	window.parent.location.href = "registro.html";
}
...
function closeLightboxRechargeIlot(){
	...
	$.ajax({
        ...
        success: function (data) {
            ...
            $(".body-account .saldo-otro").html("Bonos Loter&iacute;as: "+data.billetera3);
        }
	});
}
