...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		percentLandscape:   278,            /* Scale landscape format */
...
domReady(function()
{
	...
	instanceTwo.init({ ImageFlowID:'myImageFlowTwo',
	onClick: function() {
	}, 		
	reflections: false, 
	reflectionP: 0.0 });
	...
	instanceThree.init({ ImageFlowID:'myImageFlowThree',
	onClick: function() {},	
	reflections: false, 
	reflectionP: 0.0 });
	
	var instanceFour = new ImageFlow();
	instanceFour.init({ ImageFlowID:'myImageFlowFour',
	onClick: function() {
	}, 		
	reflections: false, 
	reflectionP: 0.0 });
