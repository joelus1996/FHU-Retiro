...
var $awardTinka = function () {
  ...
  $(".azar").click(function () {
    if (status == "ACT") {
      if (sub_total < 5005) {
        ...
        while (count < 6) {
          var number_azar = Math.round(1 + (Math.random() * (46 - 1)));
  ...
  function factorial(cantidad) {
    ...
    else if (cantidad > 1) return cantidad * factorial(cantidad - 1);
    return 1;
  }
  ...
  $("#finalize").click(function () {
    if (!$(this).hasClass("btn-disabled")) {
      ...
      if (content_object.length != 0) {
        var content_grid_2 = "<div class='label-top'></div>" + "<div class='label_1'>TINKA</div>" + "<div id='ajax-loader'>" + "<img src='layer-view-image/game/ganadiario/ajax-loader.gif'>" + "</div><div id='content-grid-result'></div>" + "<div id='num_link'></div>" + "<div id='game-no-process-info'></div>";
        ...
        $('#start_play').hide(); //oculta el form
        ...
        $.ajax({
          ...
          data: "dato=" + result_ticket + "&desist=" + top.sdesist + "&credit=" + top.scredit + "&game=41",
          dataType: "text",
          success: function (e) {
            var fila = e.split("#");
            var mensaje = "";
            ...
            if (new_content_object.length > 0) {
              ...
              jAlert(mensaje, null, function (r) {
                if (r) {
                  $(parent.location).attr('href', 'mi-cuenta.html#movimientos')
                }
              });
        ...
        jAlert("No se tiene jugadas por procesar.", null, function (r) {
          if (r) {
            $(parent.location).attr('href', 'mi-cuenta.html#movimientos')
          }
        });
  ...
  function grilla_boletos2(data) {
    ...
    for (var x in data) {
      ...
      //grilla += "<div class='" + style + "'>" + "<div class='column_1'>" + data[x][7] + "</div>" + "<div class='column_2'>" + result_ticket.substring(0, 27) + "  <span class='row-info' rel='" + x + "'>[+]</span>" + "<div class='tooltip-info'></div><div class='tooltip-info-arrow-img'></div></div>" + process_resp + "</div>";
    }
    grilla += "</div></div>";
