...
<script type="text/javascript">
	...
	<style>
		...
		.logo_kabala_cotejador img {
		    float: left;
		}
		.logo_kabala_cotejador {
		    overflow: hidden;
		}
		.logo_kabala_cotejador h2 {
		    float: left;
		    margin-left: 20px;
		    font-size: 18px;
		    color: #3c6b34;
		...
		.main-play .body-play .wrapper-playing .current-games .boxes-current-games .box-current-game.game-playing a, .main-play .body-play .wrapper-playing .current-games .boxes-current-games .box-current-game:hover a {
	    	color: #fff !important;
	    	background-color: #bdd041;
		}	
		.modal-kabala.main-play .current-game-detail {
		    margin-top: 240px;
		}
		...
		.footer-single-right button {
		    background: #c1cd00 !important;
		}
	</style>
</head>
...
<input type="hidden" value="${chChDrawEnabled}" id="chChDrawEnabled">

<div class="row cotenedor_kabala_cotejador modal-kabala">
				...
				<div class="main-play modal-coteja-boleto modal-kabala" style="width: 613px">
					<div class="body-play">
						<div class="logo_kabala_cotejador" id="kabala-cotejo-logo">
							<img src="layer-view-image/game/kabala/premios-logo-kabala.jpg"
								title="kabala" alt="kabala" class="align-img"> <h2>Coteja tu Kabala y entérate si ganaste un premio</h2>
						</div>	
														...
														<div class="box-play-main box-play-a">
															<div class="content-single-game">
																...
																<div class="footer-single-game">
																	...
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador disable" id="increases-plus-chch1">
																		<label><input type="checkbox" id="J1-check-plus" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador" id="increases-chch1">
																		<label><input type="checkbox" id="J1-check-chauchamba" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>	
																</div>
														...
														<div class="box-play-main box-play-b" style="display: none">
															<div class="content-single-game">
																...
																<div class="footer-single-game">
																	...
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador disable" id="increases-plus-chch1">
																		<label><input type="checkbox" id="J2-check-plus" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador " id="increases-chch1">
																		<label><input type="checkbox" id="J2-check-chauchamba" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>	
																</div>
														...
														<div class="box-play-main box-play-c" style="display: none">
															<div class="content-single-game">
																...
																<div class="footer-single-game">
																	...
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador disable" id="increases-plus-chch1">
																		<label><input type="checkbox" id="J3-check-plus" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador " id="increases-chch1">
																		<label><input type="checkbox" id="J3-check-chauchamba" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="chauchamba">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>	
																</div>
															</div>
														...
														<div class="box-play-main box-play-d" style="display: none">
															<div class="content-single-game">
																...
																<div class="footer-single-game">
																	...
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador disable" id="increases-plus-chch1">
																		<label><input type="checkbox" id="J4-check-plus" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>
																	<div class="checkbox-chau-chamba increases-your-prize_cotejador " id="increases-chch1">
																		<label><input type="checkbox" id="J4-check-chauchamba" class="check-plus check-chch"></label>
																		<img class="image-chaoChamba" src="layer-view-image/v2/logo-chauchamba.png" alt="Jugar La Tinka">
																		<span>Marca la casilla si también elegiste Chau Chamba en tu compra</span>
																	</div>	
																</div>
																	...
																	<div class="col-9">
																		<div class="selectBox">
																			 <c:forEach items="${kabalaSaleList}" var="kabalaSaleList" begin="0" end="0">
																			   <div class="box" id="box-2">${kabalaSaleList.id.drawId} el ${kabalaSaleList.drCloseDate}</div> 
																			   </c:forEach>
																		...
																		<div class="selectBox">
																			<div class="fechaCant">
																				<div class="checkcotent">
																					<c:forEach items="${kabalaSaleList}" var="kabalaSaleList" begin="0" end="0">
																				     <span id="fechaCotejo">${kabalaSaleList.id.drawId}</span>
																				     </c:forEach>
																				</div>
																			</div>
																		</div>
...
<!-- 																<button id="buy" type="button" onclick="return false;" class="button button-lg button-no-shadow button-block button-orange"><b>COTEJAR</b></button> -->
																<button id="btn_desktop_cotejar_boleto_kabala" type="button" onclick="return false;" class="button button-lg button-no-shadow button-block button-orange"><b>COTEJAR</b></button>
...
<script type='text/javascript' src='layer-view-script/common/jquery-3.6.3.min.js'></script>
	...
	<script type='text/javascript'
		src='layer-view-script/game/kabala/lotto-kabala-cotejador.js?v=2'></script>
	<script type="text/javascript"
