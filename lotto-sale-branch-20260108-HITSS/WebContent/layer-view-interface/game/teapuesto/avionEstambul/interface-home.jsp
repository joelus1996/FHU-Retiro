...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="main-content" style="top: 0px;padding-top: 0px;">   																							
		<div class="main-game promSorteo" style="background-color: #d7e2e4;">
			<img src="layer-view-image/game/teapuesto/avionEstambul/home-desktop-estambul.png" alt="Te Apuesto te lleva a la Final de la Champions 2023" style="width: 100%;" >
			<h2 style="color: #f75b1e;">Tus jugadas desde S/ 10 realizadas </h2>
			<h2 style="color: #f75b1e;">en la WEB</h2>
			<h3 style="color: #000000;">¡Participan automáticamente!</h3>
			<div class="copa-opciones2">													
				<button style="width: 179px;padding: 5px 5px 5px 5px;margin-top:0px" type="button" id="btnAvionEstambulResultados" onclick="return false;"class="button-avion-qatar-naranja" >Ver mis jugadas</button>
			</div>
			<div class="copa-opciones2">													
				<button style="width: 179px;padding: 5px 5px 5px 5px;" type="button" id="btnAvionEstambulComoParticipar" onclick="return false;"class="button-avion-qatar-blanco" >Términos y condiciones</button>											
			</div>	 
