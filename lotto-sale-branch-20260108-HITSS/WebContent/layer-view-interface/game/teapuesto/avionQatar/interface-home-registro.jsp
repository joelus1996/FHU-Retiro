...
<!-- End Google Tag Manager -->
    ...
    <title>Juego de apuestas deportivas en Perú - Te Apuesto </title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="main-content" style="top: 0px;padding-top: 0px;">   																							
					<div class="main-game copa-casa" style="background-color: #d7e2e4;">
						<img src="layer-view-image/game/teapuesto/avionQatar/Banner-header-desktop.png" alt="Apuestas Mundial Qatar 2022 Te Apuesto" style="width: 100%;">
						<h2 style="color: #f75b1e;">Participa con tus tickets desde S/ 10</h2>
						<h3 style="color: #000000;">¿Quieres participar en la promoción?</h3>																			
						<div class="copa-opciones2">
							<button style="width: 179px;" type="button" id="btnAvionQatarRegistrar" onclick="return false;"class="button-avion-qatar-naranja" >Si quiero</button>
						</div>			
						<div class="f_linea-copabicolor2"></div>
						<div class="copa-opciones2">
							<button style="width: 179px;" type="button" id="btnAvionQatarComoParticipar" onclick="return false;"class="button-avion-qatar-blanco">¿Cómo participar?</button>																																		
						</div>																																	
						<div class="copa-descripcion">
							<h3 style="color: #000000;">Del jueves 01 de setiembre al domingo 20 de noviembre del 2022</h3>
						</div>
					</div>														
    </div>
