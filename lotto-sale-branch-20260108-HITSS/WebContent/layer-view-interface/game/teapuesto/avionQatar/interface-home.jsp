    ...
    <div class="main-content" style="top: 0px;padding-top: 0px;">   																							
		<div class="main-game promSorteo" style="background-color: #d7e2e4;">
			...
			<div class="copa-opciones2">													
				<button style="width: 179px;padding: 5px 5px 5px 5px;margin-top:0px" type="button" id="btnAvionQatarResultados" onclick="return false;"class="button-avion-qatar-naranja" >Ver mis jugadas</button>
			</div>
			<div class="copa-opciones2">													
				<button style="width: 179px;padding: 5px 5px 5px 5px;" type="button" id="btnAvionQatarComoParticipar" onclick="return false;"class="button-avion-qatar-blanco" >Términos y condiciones</button>											
			</div>	 
