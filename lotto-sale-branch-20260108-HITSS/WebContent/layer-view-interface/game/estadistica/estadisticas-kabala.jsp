...
<head>
	...
	<title>Estadisticas Kabala</title>
...
<body style="border:0; margin:0;">
	<div class="contenido kabala">
		<div class="controles">
			<div class="mensaje1">
				Revisa cu&aacute;ntas veces fueron extra&iacute;das cada una de las 40 bolillas en el sorteo de la Kabala.
			</div>
		...
		<div class="controles controles2">
			<div class="mensaje1">
				Ent&eacute;rate en qu&eacute; meses revent&oacute; el pozo buenazo de K&aacute;bala.
			</div>
			<div style="clear:both"></div>
		</div>
		<div id="resultado2">
