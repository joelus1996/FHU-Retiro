...
<head>
	...
	<link media="screen" rel="stylesheet" type="text/css" href="layer-view-style/client/mainCollectPrize.css?v=24">
...
<section class="ipremio">
	...
	<div class="ioverlay modal-msg" id="modal-confirmar-eliminar-cuenta-transferencia">
      <div class="modal is-error" style="width: 433px;">
	...
	<div class="ioverlay modal-msg" id="modal-confirmar-retiro-transferencia">
      <div class="modal is-error" style="width: 433px;">
        <div class="modal__boby" style="padding-bottom: 20px; padding-left: 70px; padding-right: 70px;" >          
          <div>
          	<p style='text-align: center; margin-bottom: 0px;'> 
          ...
          <button class="btn btn_green" id="aceptar-confirmar-retiro-transferencia" onclick="continuarRetiroTransferenciaPin()" style="background: #07663a; margin: 20px auto 0;">Confirmar retiro</button>
	...
	<div class="ioverlay modal-msg" id="modal-confirmar-retiro-transferencia-pin">
      <div class="modal is-error" style="width: 433px;">
       <div class="modal__close2" onclick="closeModal()"><span class="icon-cerrar"></span></div>
        <div class="modal__boby" style="padding-bottom: 20px; padding-left: 70px; padding-right: 70px;" >          
          <div>
          	<p style='text-align: center; margin-bottom: 0px;'> 
	          	<span style='font-size: 16px; font-weight: 700;' id="ecoPinTitulo"></span> <br><br> 
          	</p>
          	<p style="line-height: 15px;"><span id="ecoPinMensaje"></span>
          	</p>
	...
	<div class="ioverlay modal-msg" id="modal-confirmar-retiro-efectivo">
      <div class="modal is-error" style="width: 433px;">
        <div class="modal__boby" style="padding-left: 42px; padding-right: 42px;">          
          <div>
	...
	<div class="ioverlay" id="modal-success">
      <div class="modal is-success">
        ...
        <div class="modal__boby">
          ...
          <div class="modal__links" style="text-align: center; margin-bottom: 15px; display: block;">
          	<a class="no-underline" style="color: #e30613;" href="#" id="historialRetiros" toggle-modal="#modal-listado"><span>Historial de retiros</span></a>
          </div>
          <hr>
          <div class="modal__links" style="padding-top: 10px; padding-left: 60px; padding-right: 60px;">
          	<a class="no-underline" href="juega-kinelo.html"><span>Jugar Kinelo</span></a>
          	<a class="no-underline" href="#" onclick="toJuegosVirtuales('virtuales');"><span>Jugar Deportes Virtuales</span></a>
          </div>
        </div>
      </div>
    </div>
            ...
            <ul class="accordion is-main">
              <li class="accordion__item opened is-modal">
                ...
                <div id="bodyPrincipal" class="accordion__body content_loading">
                  ...
                  <div id="listaPremiosMayoresLoterias" style="padding-right: 9.5238095238%; padding-left: 9.5238095238%;"></div>
                  ...
                  <div class="inner">
                    ...
                    <ul class="accordion is-method listaMetodosRetiro">
                      <li class="accordion__item" id="accordion_efectivo" style="display: none;">
                        <h2 class="accordion__title" style="cursor: pointer;"><span class="icon-efectivo"></span>Efectivo / Punto de venta<span class="info" id="rangoMontosEfectivo"></span></h2>
                            ...
                            <form class="metodo-efectivo steps" autocomplete="off" id="formefectivo">
                              <div id="step"  class="step"><i id="stepUnoEfectivo">1</i>
	                              <div class="form-item" id="divMontoEfectivo">
	                                ...
	                                <div class="input">
	                                  ...
	                                  <input class="is-numeric" type="text" name="iamount" id="amountEfectivo" maxlength="10" data-min="0" data-max="0" data-valid="amount">
	                                </div>
                              ...
                              <div id="divStepDNIEfectivo" class="step hidden"><i>2</i>                          
                                <div class="fileup-image" id="divImgDniEfectivo">
								  ...
								  <div class="divDniPen" id="divDniLabelEfectivo">
									  <label id="stateDniPENLabelEfectivo" class="btn is-secondary img-simple" style="display: none;"><span class="text">Subir imagen</span>
									  ...
									  <span id="stateDniACTLabelEfectivo" style="display: none;">
										...
										<a id="updateDNIEfectivo" style="text-decoration: underline; color: #e30613; cursor: pointer;">
											hazlo aquí
										</a>
									  </span>      
                              ...
                              <div class="step hidden" id="stepKYCEfectivo"><i id="stepCardSDKVisa">2</i>Verifica tus datos por única vez cada 36 meses, si tus datos son correctos.
									<div class="form_visa" id="divEfectivoKYC">
	                                	...
	                                	<label class="form_visa_card_button" id="efectivoSDKCardButton" onclick="showSDK()">VERIFICA TU IDENTIDAD
	                                	...
	                                	<span class="form_visa_card_mask hidden" id="sdkEfectivoCardText">
	                                		...
	                                		<span id="efectivoSDKVerificado"></span>
...
<!-- 	                                	<button type="button" id="consultResultKyc4" class = "btn-verificar" >Verificar</button> -->
	                           ...
	                           <div class="step" style="margin-top: 5px; font-size: 12px; ">Podrás cobrar tu retiro únicamente en efectivo, en nuestros Puntos de Venta</div>
                     ...
                     <li class="accordion__item" id="accordion_visa" style="display: none;">                      
                        <h2 class="accordion__title" style="cursor: pointer;"><span class="icon-tarjeta"></span>Visa<span class="info" id="rangoMontosVisa"></span></h2>
                        <div class="accordion__body">
...
<!--                               <div class="steps-title">Pasos a seguir:</div> -->
                              ...
                              <div id="divStepDNI" class="step hidden"><i>2</i>                                
                               <div class="fileup-image" id="divImgDni">
                                  ...
                                  <span id="stateDniACT" style="display: none; line-height: 16px; margin-bottom: 10px;">
                               	  ...
                               	  <div class="divDniPen" id="divDniLabel">
	                                  <label id="stateDniPENLabel" class="btn is-secondary img-simple" style="display: none;"><span class="text">Subir imagen</span>
	                                    ...
	                                    <canvas id="canvasDNI" style="display: none;" ></canvas>
	                               	  ...
	                               	  <span id="stateDniACTLabel" style="display: none;">
	                           			<span>¿Quieres actualizarlo?</span>
	                           			<a id="updateDNI" style="text-decoration: underline; color: #e30613; cursor: pointer;">
	                           				hazlo aquí
	                           			</a>
	                               	  </span>      
                               ...
                               <div class="step"><i id="stepCard">2</i>Selecciona o añade tu tarjeta
                                <div class="form_visa" id="divVisa">
                                	...
                                	<label class="form_visa_card_button" id="visaCardButton" onclick="showTokenization()">Seleccionar
                            ...
                            <div class="step hidden"  id="stepKYCVisa"><i id="stepCardSDKVisa">3</i>Verifica tus datos por única vez cada 36 meses, si tus datos son correctos.
                                <div class="form_visa" id="divVisaKYC">
                                	<img  class="form_visa_logo" src="layer-view-image/client/icon_dni.png?v=3" style="margin-left: 5px; margin-top: -10px; margin-right: 38px;">
                                	<label class="form_visa_card_button" id="visaSDKCardButton" onclick="showSDK()">VERIFICA TU IDENTIDAD
                                	...
                                	<span class="form_visa_card_mask hidden" id="visaSDKCardText">
                                		...
                                		<span id="visaSDKVerificado"></span>
...
<!--                                 	<button type="button" id="consultResultKyc1" class = "btn-verificar" >Verificar</button> -->
                                ...
                                <div style="margin-top: 10px; font-size: 10px; font-weight: 700; text-align: justify;">Deberés permitir el acceso a tu cámara para realizar la verificación.</div>
                     ...
                     <li class="accordion__item" id="accordion_agora" style="display: none;">                      
                        <h2 class="accordion__title" style="cursor: pointer;"><span class="icon-tarjeta"></span>Agora<span class="info" id="rangoMontosAgora"></span></h2>
                        <div class="accordion__body">
                          <div class="inner">
...
<!--                               <div class="steps-title">Pasos a seguir:</div> -->
                              ...
                              <div id="divStepDNIAgora" class="step hidden"><i>2</i>                                
                               <div class="fileup-image" id="divImgDniAgora">
                                  ...
                                  <span id="stateDniACTAgora" style="display: none; line-height: 16px; margin-bottom: 10px;">
                               	  ...
                               	  <div class="divDniPen" id="divDniLabelAgora">
	                                  <label id="stateDniPENLabelAgora" class="btn is-secondary img-simple" style="display: none;"><span class="text">Subir imagen</span>
	                                    ...
	                                    <canvas id="canvasDNIAgora" style="display: none;" ></canvas>
	                               	  ...
	                               	  <span id="stateDniACTLabelAgora" style="display: none;">
	                           			<span>¿Quieres actualizarlo?</span>
	                           			<a id="updateDNIAgora" style="text-decoration: underline; color: #e30613; cursor: pointer;">
	                           				hazlo aquí
	                           			</a>
	                               	  </span>      
                              ...
                              <div class="step"><i id="stepCardSDKAgora">3</i>Verifica tus datos por única vez cada 36 meses, si tus datos son correctos.
								<div class="form_visa" id="divAgoraKYC">
                                	<img  class="form_visa_logo" src="layer-view-image/client/icon_dni.png?v=3" style="margin-left: 5px; margin-top: -10px; margin-right: 38px;">
                                	<label class="form_visa_card_button" id="agoraSDKCardButton" style="margin-left: 15px;" onclick="showSDK()">VERIFICA TU IDENTIDAD
                                	...
                                	<button type="button" id="consultResultKyc2" class = "btn-verificar" >Verificar</button>
                                </div>
                                <div style="margin-top: 10px; font-size: 10px; font-weight: 700; text-align: justify;">Deberás permitir el acceso a tu cámara para realizar la verificación.</div>
                     ...
                     <li class="accordion__item" id="accordion_transferencia" style="display: none;">
                      	<h2 class="accordion__title" style="cursor: pointer;"><span class="icon-transferencia"></span>Transferencia Bancaria<span class="info" id="rangoMontosTransferencia"></span></h2>                     	
                      	<div class="accordion__body">
                      		<div class="inner" style="padding-top: 3px; padding-right: 0px; padding-left: 0px; width: 101%;">
                      			...
                      			<form class="metodo-transferencia steps" autocomplete="off" id="formtransferencia" style="padding-right: 6.66667%; padding-left: 6.66667%;">
									...
									<div id="divStepDNITransferencia" class="step hidden"><i id="stepDniTransferencia">4</i>
										<div class="fileup-image" id="divImgDniTransferencia">
										  ...
										  <div class="divDniPen" id="divDniLabelTransferencia">
											<label id="stateDniPENLabelTransferencia" class="btn is-secondary img-simple" style="display: none;"><span class="text">Subir imagen</span>
											...
											<span id="stateDniACTLabelTransferencia" style="display: none;">
												<span>¿Quieres actualizarlo?</span>
												<a id="updateDNITransferencia" style="text-decoration: underline; color: #e30613; cursor: pointer;">
													hazlo aquí
												</a>
											</span>      
									...
									<div class="step" id="divStepDeparmentTransferencia"><i id="stepDeparmentTransferencia">4</i>Selecciona el departamento donde abriste tu cuenta
									...
									<div class="step hidden" id="stepKYCTrans"><i id="stepCardSDKTransferencia">5</i>Verifica tus datos por única vez cada 36 meses, si tus datos son correctos.
										<div class="form_visa" id="divTransferenciaKYC">
		                                	<img  class="form_visa_logo" src="layer-view-image/client/icon_dni.png?v=3" style="margin-left: 5px; margin-top: -10px; margin-right: 38px;">
		                                	<label class="form_visa_card_button" id="transferenciaSDKCardButton" onclick="showSDK()">VERIFICA TU IDENTIDAD
		                                	...
		                                	<span class="form_visa_card_mask hidden" id="sdkTransferenciaCardText">
		                                		...
		                                		<span id="transferenciaSDKVerificado"></span>
...
<!-- 		                                	<button type="button" id="consultResultKyc3" class = "btn-verificar" >Verificar</button> -->
		                                ...
		                                <div  style="margin-top: 5px; font-size: 10px; font-weight: 700;">Deberás permitir el acceso a tu cámara para realizar la verificación.</div>
		                                
		                              </div>
									  
		                              <div class="step" style="margin-top: 5px; font-size: 10px; font-weight: 700; text-align: justify;">Asegúrate de ser el titular de la cuenta y que los datos de tu cuenta de La Tinka sean iguales a los de tu cuenta bancaria. Caso contrario, tu retiro será rechazado.</div>
									<button class="btn btn-solicitar">Solicitar Retiro</button>
                      			</form>
                      		</div>
                      	</div>
                    ...
                    <div class="footlinks">Historial<a class="linkbox" href="#" toggle-modal="#modal-listado">Retiros</a></div>
                  </div>
                </div>
              </li>
            </ul>
                ...
                <div class="accordion__body">
                  <div class="inner">
                    ...
                    <div class="record__content">
                      <div class="filter">
                        <div class="filter__title"><span>Filtrar</span></div>
                      ...
                      <div class="pagination" id="pagination-items-hispayment">
                        <div class="pages"></div><a class="prev" href=""><i class="icon-regresar"></i></a><a class="next" href=""><i class="icon-siguiente"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="ioverlay" id="modal-ticket2">
      <div class="modal is-ticket">
        ...
        <div class="back"><a href="#" id="volverModalRetiros" onclick="volverModalRetiros()">Volver a retiros</a></div>
        <div class="content_loading"> 
	        ...
	        <div class="modal__footer">
	          <form class="form frm-newsletter" action="downloadTicketsPP.html" method="post" name="formDownload" id="formDownload">
	          	<span class="down is-cian no-underline"><span onclick="downloadTicketsPP()">Descargar</span></span>
	            <div class="form-item is-sendmail">
	              <button class="btn btn-sendemail" style="position: inherit; width: 140px; border-radius: 5px;">Enviar por email</button>
	            </div>
      ...
      <div class="modal is-ticket">
        ...
        <div class="modal__head">
          <ul>
            <li><strong>Cod. de Retiro: </strong><span id="tkRequestNumberDebitIdQR"></span></li>
            <li><strong>Fecha y hora: </strong><span id="tkRequestDateHourDebitIdQR"></span></li>
            <li><strong>ID: </strong><span id="idClienteDebitIdQR"></span></li>
            <li><strong>DNI: </strong><span id="tkDocNumberDebitIdQR"></span></li>
            <li><strong>Ganador: </strong><span id="ganadorDebitIdQR"></span></li>
          </ul>
        </div>
        <div class="back"><a href="#" id="volverModalRetirosDebitIdQR" onclick="volverModalRetirosDebitIdQR()">Volver a retiros</a></div>
        <div class="content_loading"> 
	        <div class="modal__body" style="padding-top: 0px;">
	          <div>
	            <div class="label-total">Monto de retiro:</div>
	            <div class="total"><strong>Total: </strong>S/<span id="tkRequestAmountDebitIdQR"></span></div>
	        ...
	        <div class="modal__footer">
	          <form class="form frm-newsletterDebitIdQR" action="downloadTicketsPPDebitIdQR.html" method="post" name="formDownloadDebitIdQR" id="formDownloadDebitIdQR">
	          	<span class="down is-cian no-underline"><span onclick="downloadTicketsPPDebitIdQR()">Descargar</span></span>
	            <div class="form-item is-sendmail">
	              <button class="btn btn-sendemail" style="position: inherit; width: 140px; border-radius: 5px;">Enviar por email</button>
	            </div>
	            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
    	...
    	<div class="modal is-iframe full">
          <div class="ipremio in-iframe">
            <div class="ipremio__head" style="background: #07663a; color: #fff; font-family: Avenir, sans-serif; font-weight: 800; font-size: 32px; line-height: inherit; padding: 25px 9.5238095238%; height: auto;">Retirar premios
              <div class="modal__close iclose"><span class="icon-cerrar"></span></div>
            </div>
            <div class="ipremio__body">
              <ul class="accordion record">
                <li class="accordion__item opened is-modal" style="margin-bottom: 0px;">
                  <div class="accordion__body">
                    <div class="inner" style="padding-bottom: 1px;">
                      <div class="back"><a href="#" toggle-modal="#modal-premios">Volver</a></div>
                      <div class="record__content" style="border: 1px solid #E2E2E2; margin-top: 18px; margin-left: 9.5238095238%; margin-right: 9.5238095238%; padding-right: 0px; padding-left: 0px; padding-bottom: 24px; margin-bottom: 18px; padding-top: 10px;">               	
                      	<div>
                      		<div class="inner" style="padding-top: 3px; padding-right: 0px; padding-left: 0px; width: 101%;">	
                   					...
                   					<tbody>
                   						<tr>
                   							...
                   							<td style="text-align: right;">
	                   							...
	                   							<span style="font-size: 14px; float: left; padding-left: 160px;">Impuesto (10%): S/ </span><span style="padding-right: 6.66667%; font-size: 14px;" id="impuesto"></span><br>
	                   							<span style="font-size: 14px; font-weight: 700; float: left; padding-left: 160px;">Monto a cobrar: S/ </span><span style="padding-right: 6.66667%; font-size: 14px; font-weight: 700;" id="neto"></span>
	                   							<span style="font-size: 14px; font-weight: 700; float: left; padding-left: 160px;" id="txtJugadasGratis">Jugadas gratis:</span><span style="padding-right: 6.66667%; font-size: 14px; font-weight: 700;" id="lblJugadasGratis"></span>
                   							</td>
                   						</tr>
                   					</tbody>
                   				</table>
                      			...
                      			<form class="metodo-transferencia steps" autocomplete="off" id="formtransferenciapml" style="padding-right: 6.66667%; padding-left: 6.66667%; margin-top: 60px;">
									...
									<div id="divStepDeparmentTransferenciaPML" class="step"><i id="stepDeparmentTransferenciaPML">4</i>Selecciona el departamento donde abriste tu cuenta
									  <div class="form-item ispad15" id="divDepartamentoPML">
									   ...
									   <div class="step" style="margin-top: 10px; font-weight: 700; font-size: 10px;">Asegúrate de ser el titular de la cuenta y que los datos de tu cuenta de La Tinka sean iguales a los de tu cuenta bancaria. Caso contrario, tu retiro será rechazado.</div>
                ...
                <div class="accordion__body">
                  <div class="inner">
                    ...
                    <div class="record__content nofound">
                      <div class="nofound__title">Aún no has hecho ningun retiro</div><img class="nofound__img" src="layer-view-image/client/no-retiros.svg?v=2" alt="Sin retiros">
                      <div class="nofound__alert">¡Sigue jugando!</div>
                      <div class="nofound__links"><a class="no-underline" href="juega-kinelo.html"><span>Jugar Kinelo</span></a><a class="no-underline" href="#" onclick="toJuegosVirtuales('virtuales');"><span>Jugar Deportes Virtuales</span></a></div>
                    </div>
                  </div>
                </div>
              </li>
...
<script type="text/javascript" src="layer-view-script/client/libsCollectPrize.js?v=4"></script>
<script type="text/javascript" src="layer-view-script/client/mainCollectPrize.js?v=81"></script>
