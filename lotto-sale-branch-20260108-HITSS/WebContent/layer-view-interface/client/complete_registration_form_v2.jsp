        ...
        <div class="registro">
          ...
          <div class="content">
            ...
            <div class="registro__form">
              <form class="form"	id="frm-user-register" action="completando-registro.html" 		autocomplete="off" method="post">
                ...
                <div class="form__input ridisabledInput" style="background-color: #F7F7F7;">
                  ...
                  <input  name="idocument-type" id="idocument-type" value="${typedoc}" readonly>
<!--                   <select name="document-type" id="document-type" tabindex="10" data-validation="required" data-validation-error-msg="Seleccionar un tipo de documento" disabled> -->
                ...
                <c:choose>
                	<c:when test= "${typedoc eq 'DNI' }">                
		                <div class="form__input form__optional show ridisabledInput" id="divNumberDoc" style="background-color: #F7F7F7;">
		                  ...
		                  <input readonly type="text" name="document-number" tabindex="11" 
		                  id="document-number" maxlength="8" data-validation="length number" data-validation-length="8" 
               		...
               		<c:when test="${typedoc eq 'PASAP' }">                
						<div class="form__input form__optional show ridisabledInput" id="div-documento-pasap" style="background-color: #F7F7F7;">
		                  ...
		                  <input readonly type="text" name="document-number-pasap" tabindex="11" 
		                  ...
		                  data-validation-depends-on="document-type" data-validation-depends-on-value="PASAP" value="${ document}">
		                </div>
               		</c:when>
               		<c:when test="${tupedoc eq 'CAREX'}">                
		                <div class="form__input form__optional show ridisabledInput" id="div-documento-carex" style="background-color: #F7F7F7;">
		                  ...
		                  <input readonly type="text" name="document-number-carex" tabindex="11" 
		                  id="document-number-carex" maxlength="12" data-validation="length alphanumeric" 
		                  data-validation-length="min9max12" data-validation-error-msg="Ingresa un Carnet de Extranjería válido" 
		                  data-validation-depends-on="document-type" data-validation-depends-on-value="CAREX" value="${ document}">
		                </div>
                    </c:when>		                
                </c:choose>                
...
<!--                     <option value="">Nacionalidad</option>  -->
                ...
                <div class="form__input ridisabledInput" style="background-color: #F7F7F7;">
                  ...
                  <input type="text" name="mobile-phone1" id="mobile-phone1" tabindex="18" maxlength="9" 
                  readonly value="${cel}">
                </div>
                <div class="form__input">
...
<!--                   <label>¿Quieres recibir promociones y noticias a tu correo electrónico y/o celular?</label> -->
                ...
                <div class="form__button">
                  ...
                  <button class="button button__base_3" type="button" id="cancelarCompletarRegistro" 
                  style="background-color:#808080; border: solid 2px #808080; margin-left: 40px; "
                  onclick='goRegister();'>Cancelar</button>
