...
<body class="no-scroll" style="overflow-y: hidden;">
	...
	<input type="hidden" id="environment" value="<%=Constants.EPAGO_ENVIRONMENT%>" >
	<input type="hidden" id="paymentMethods" value="<%=Constants.EPAGO_PAYMENT_METHODS%>" >
...
<img id="logo" class="header-logoImage" src="" alt="Logo" style=" max-width: 180px; width: 90%; max-height: 85px;">
...
<div id="cart-container" class="epago-container" style="overflow-y: hidden; padding-left: 19px; padding-right: 8px;">
            	...
            	if (response.data.result.accepted) {
            		...
            		referenceNumber = referenceNumber.substring(referenceNumber.length - 15);
	          	  	...
	          	  	window.parent.postMessage("hideLightboxIzipay|"+
	          			  "AUTHORIZED|"+
	          			response.data.payment.uniqueIdentifier+"|"+
...
$(document).ready(function(){
	...
	if(operatorId=="5588"){
		...
		$("#logo").attr("src","layer-view-image/v2/logo-tinka.svg?v=3");
