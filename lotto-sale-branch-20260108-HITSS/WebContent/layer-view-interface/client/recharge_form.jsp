	              ...
	              <div class="recharge__content">
	                ...
	                <div class="recharge__body">
	                  ...
	                  <div class="tabs">
	                    ...
	                    <div class="back" style="display: none;"><a href="#">Volver a los métodos de recarga</a></div>
	                    <div class="tabs__container" id="tabs__container" style="margin-top: 30px;">
	                      <!-- tab internet-->
	                      <div class="tabs__container-item" id="internet" style="min-height: 300px !important;">
	                        <div class="tabs" data-category="Recarga por Internet-Decide">
	                          <div id="botonesInternet" class="buttoms__recharge">
	                          	<div id="tabInternetVisanet" class="buttom__recharge" data-target="#visanet-internet" data-label="Cargar Saldo - tab visanet" onclick="tagginTabCargarSaldo('internetVisanet');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-visanet" src="layer-view-image/client/logo-visa-mc.png" style="height: 34px;"> -->
...
<!-- 	                          		</div> -->
	                          	...
	                          	<div id="tabInternetAgora" class="buttom__recharge" data-target="#agora-internet" data-label="Cargar Saldo - tab agora" onclick="tagginTabCargarSaldo('internetAgora');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-agora" src="layer-view-image/client/logo-agora.png" style="padding-top: 17px;"> -->
<!-- 	                          			<span><img src="layer-view-image/client/arrow.png"></span> -->
<!-- 	                          			<p style="font-weight: 700 !important;" class="subcontent-text"> -->
...
<!-- 	                          		</div> -->
									<table>
	                          			<tr style="height: 47px;">
	                          				<td style="width: 300px;">
	                          					<a class="img-recharge">
	                          						<img class="img-agora" src="layer-view-image/client/logo-agora2.png" style="height: auto; position: absolute; left: 34px; bottom: -20px;">
	                          					</a>
											</td>
	                          			</tr>
	                          			<tr>
	                          	...
	                          	<div id="tabInternetYape" class="buttom__recharge" data-target="#yape-internet" data-label="Cargar Saldo - tab yape" onclick="tagginTabCargarSaldo('internetYape');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-yape" src="layer-view-image/client/yape.png" style="height: auto; width: 65px; padding-top: 13px;"> -->
<!-- 	                          			<span><img src="layer-view-image/client/arrow.png"></span> -->
<!-- 	                          			<p style="font-weight: 700 !important; margin-top: 0px;" class="subcontent-text"> -->
...
<!-- 	                          		</div> -->
									<table>
	                          			<tr style="height: 47px;">
	                          				<td style="width: 300px;">
	                          					<a class="img-recharge">
	                          						<img class="img-yape" src="layer-view-image/client/yape.png" style="height: auto; position: absolute; left: 30px; bottom: -27px;">
	                          					</a>
											</td>
	                          			</tr>
	                          			<tr>
	                          	...
	                          	<div id="tabInternetInterbank" class="buttom__recharge" data-target="#interbank-internet" data-label="Cargar Saldo - tab interbank" onclick="tagginTabCargarSaldo('internetInterbank');">
<!-- 	                          		<div> -->
...
<!-- 	                          		</div> -->
	                          	...
	                          	<div id="tabInternetBCP" class="buttom__recharge" data-target="#bcp-internet" data-label="Cargar Saldo - tab BCP" onclick="tagginTabCargarSaldo('internetBCP');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-bcp" src="layer-view-image/client/logo-bcp.png" style="padding-top: 17px;"> -->
<!-- 	                          			<span><img src="layer-view-image/client/arrow.png" style="margin-left: 22px;"></span> -->
<!-- 	                          			<p style="font-weight: 700 !important;" class="subcontent-text"> -->
...
<!-- 	                          		</div> -->
	                          	...
	                          	<div id="tabInternetPlin" class="buttom__recharge" data-target="#plin-internet" data-label="Cargar Saldo - tab plin" onclick="tagginTabCargarSaldo('internetPlin');">	                          		
	                          		<table>
	                          			<tr style="height: 47px;">
	                          				<td style="width: 300px;">
	                          					<a class="img-recharge">
	                          						<img class="img-yape" src="layer-view-image/client/plin.png" style="height: auto; width: 35px; position: absolute; left: 55px; bottom: -20px;">
	                          					</a>
											</td>
	                          			</tr>
	                          			<tr>
	                          	...
	                          	<div id="tabInternetPagoEfectivo" class="buttom__recharge" data-target="#pagoefectivo-internet" data-label="Cargar Saldo - tab pagoefectivo" onclick="tagginTabCargarSaldo('internetPagoEfectivo');">
<!-- 	                          		<div> -->
...
<!-- 	                          		</div> -->
									<table>
	                          			<tr style="height: 47px;">
	                          				<td style="width: 300px;">
	                          					<a class="img-recharge">
	                          						<img class="img-pagoefectivo" src="layer-view-image/client/logo_pe_desktop.png" style="height: auto; position: absolute; left: 32px; bottom: -12px; width: 75px;">
	                          					</a>
											</td>
	                          			</tr>
	                          			<tr>
	                          	...
	                          	<div id="tabInternetSafetyPay" class="buttom__recharge" data-target="#safetypay-internet" data-label="Cargar Saldo - tab safetypay" onclick="tagginTabCargarSaldo('internetSafetyPay');">
<!-- 	                          		<div> -->
...
<!--         								  	<iframe id="frameButtonVisa" frameborder="0" style="width:100%; height:100%"></iframe> -->
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_visanet" tabindex="117" maxlength="4" data-validation="number" data-validation-allowing="range[10;1000]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
...
<!-- 	                                <p class="subcontent-text"><strong>Con tu tarjeta Agora:</strong></p> -->
									<img class="img-agora" src="layer-view-image/client/logo-agora2.png" style="margin-top: 14px;">
	                                ...
	                                <ol class="subcontent-list">
	                                  <li style="margin-bottom: 0px;">Ingresa el monto a recargar. Si tienes un código promocional, escríbelo ahora, y presiona "APLICAR" para hacerlo efectivo.
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_agora" tabindex="115" maxlength="4" data-validation="number" data-validation-allowing="range[10;1000]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
									...
									<div class="subcontent-list">
										<form  class="form" id="form_recharge_ibk_i" autocomplete="off">
											...
											<div class="form__input form__input--small">
		                                        ...
		                                        <input class="codigo_promocional"  oninput="this.value = this.value.toUpperCase();" type="text" name="codigo" id="codigo_ibk_i" tabindex="119" maxlength="20">
		                                    </div>
		                                    <div class="form__gift"><img class="form__gift-icon" src="layer-view-image/client/icon-gift.svg" width="18" height="18">
...
<!-- 	                                <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
	                                  ...
	                                  <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago BCP.
	                                    <form class="form" id="form_recharge_bcp" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_bcp" tabindex="120" maxlength="5" data-validation="number" data-validation-allowing="range[0;0]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
	                                ...
	                                <p class="subcontent-link"><a class="link link__arrow link_red_new" style="cursor: pointer;" href="https://www.viabcp.com/" data-name="Decide - Cargar Saldo" data-category="Recarga por Internet-Decide" data-action="click" data-label="Cargar Saldo - tab BCP - ir a BCP" target="_blank">Ir a BCP</a></p>
	                                <div class="subcontent-footer">Verifica tu recarga en la sección "<strong>Movimientos</strong>"</div>
	                              </div>
	                            </div>
	                            <!-- tab pagoefectivo-->
	                            <div class="tabs__container-item" id="pagoefectivo-internet">
	                              <div class="subcontent">
	                               	<img class="img-pagoefectivo" src="layer-view-image/client/logo_pe_desktop.png" style="margin-top: 15px; height: auto; width: 94px; margin-bottom: 5px;">
	                                  ...
	                                  <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago PagoEfectivo.
	                                    <form class="form" id="form_recharge_pagoefectivo" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_pagoefectivo" tabindex="130" maxlength="4" data-validation="number" data-validation-allowing="range[40;3000]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
...
<!-- 	                                <div class="subcontent-footer">Verifica tu recarga en la sección "<strong>Movimientos</strong>"</div> -->
	                            ...
	                            <div class="tabs__container-item" id="yape-internet">
	                              <div class="subcontent">
	                               	<img class="img-pagoefectivo" src="layer-view-image/client/yape.png" style="margin-top: 15px; height: auto; width: 70px;">
	                               	<img class="img-pagoefectivo" src="layer-view-image/client/img_viapagoefectivo.png" style="margin-top: 20px; height: auto; width: 105px; float: right;">
	                                  ...
	                                  <li>Ingresa el monto a recargar. Si tienes un código promocional, escríbelo y presiona "APLICAR" para hacerlo efectivo.<br>Luego genera tu código QR.
	                                    <form class="form" id="form_recharge_yape" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_yape" tabindex="130" maxlength="4" data-validation="number" data-validation-allowing="range[15;500]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
	                                ...
	                                <div class="subcontent-footer" style="display: none;" id="divVerificaRecargaYape">Luego de pagar en Yape <br>
	                            ...
	                            <div class="tabs__container-item" id="plin-internet">
	                              <div class="subcontent">
	                               	<img class="img-pagoefectivo" src="layer-view-image/client/plin.png" style="margin-top: 15px; height: auto; width: 35px;">
	                                <img class="img-pagoefectivo" src="layer-view-image/client/img_viapagoefectivo.png" style="margin-top: 20px; height: auto; width: 105px; float: right;">
	                                  ...
	                                  <li>Ingresa el monto a recargar. Si tienes un código promocional, escríbelo y presiona "APLICAR" para hacerlo efectivo.<br>Luego genera tu código QR.
	                                    <form class="form" id="form_recharge_plin" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_plin" tabindex="130" maxlength="4" data-validation="number" data-validation-allowing="range[15;500]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
	                                ...
	                                <div class="subcontent-footer" style="display: none;" id="divVerificaRecargaPlin">Luego de pagar en PLIN<br>
	                                  ...
	                                  <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago SafetyPay.
	                                    <form class="form" id="form_recharge_safetypay" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_safetypay" tabindex="140" maxlength="4" data-validation="number" data-validation-allowing="range[80;3000]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
	                      ...
	                      <div class="tabs__container-item" id="efectivo" style="min-height: 190px !important;">
	                        <div class="tabs" data-category="Recarga fisica-Decide">
	                          <div id="botonesEfectivo" class="buttoms__recharge">
	                          	<div id="tabEfectivoInterbank" class="buttom__recharge" data-target="#interbank-efectivo" data-label="Cargar saldo - tab interbank" onclick="tagginTabCargarSaldo('efectivoInterbank');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-interbank" src="layer-view-image/client/logo-interbank.png" style="padding-top: 18px; height: auto; width: 80px;"> -->
<!-- 	                          			<span><img src="layer-view-image/client/arrow.png"></span> -->
<!-- 	                          			<p style="font-weight: 700 !important;" class="subcontent-text"> -->
...
<!-- 	                          		</div> -->
	                          	...
	                          	<div id="tabEfectivoLotocard" class="buttom__recharge" data-target="#lotocard-efectivo" data-label="Cargar saldo - tab lotocard" onclick="tagginTabCargarSaldo('efectivoLotocard');">
<!-- 	                          		<div> -->
...
<!-- 	                          		</div> -->
	                          	...
	                          	<div id="tabEfectivoPagoEfectivo" class="buttom__recharge" data-target="#pagoefectivo-efectivo" data-label="Cargar saldo - tab pagoefectivo" onclick="tagginTabCargarSaldo('efectivoPagoEfectivo');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-pagoefectivo" src="layer-view-image/client/logo_pe_desktop.png" style="height: auto; width: 75px; padding-top: 13px;"> -->
<!-- 	                          			<span><img src="layer-view-image/client/arrow.png"></span> -->
<!-- 	                          			<p style="font-weight: 700 !important;" class="subcontent-text"> -->
...
<!-- 	                          		</div> -->
	                          	...
	                          	<div id="tabEfectivoSafetyPay" class="buttom__recharge" data-target="#safetypay-efectivo" data-label="Cargar saldo - tab safetypay" onclick="tagginTabCargarSaldo('efectivoSafetyPay');">
<!-- 	                          		<div> -->
<!-- 	                          			<img class="img-safetypay" src="layer-view-image/client/logo-safety-pay.png" style="height: auto; width: 75px; padding-top: 15px;"> -->
<!-- 	                          			<span><img src="layer-view-image/client/arrow.png"></span> -->
<!-- 	                          			<p style="font-weight: 700 !important;" class="subcontent-text"> -->
	                                ...
	                                <div class="subcontent-list">
										<form class="form" id="form_recharge_ibk_e" autocomplete="off">
											...
											<div class="form__input form__input--small">
		                                        ...
		                                        <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" type="text" name="codigo" id="codigo_ibk_e" tabindex="121" maxlength="20">
		                                    </div>
		                                    <div class="form__gift"><img class="form__gift-icon" src="layer-view-image/client/icon-gift.svg" width="18" height="18">
		                                        <button class="button button__outline button--small" type="button" data-label="Cargar Saldo - tab IBK - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Código correcto</span>
		                                    </div>
	                                    ...
	                                    <li>Digita el código PIN de 14 dígitos de tu Lotocard. <br>Si tienes un código promocional aplícalo ahora. <br>Luego, haz click en el botón "Cargar".
	                                      <form class="form" id="form_recharge_lotocard" autocomplete="off">
	                                        ...
	                                        <div class="form__input form__input--small">
	                                          ...
	                                          <input type="text" name="lotocard" id="lotocard" tabindex="150" maxlength="14" data-validation="length number" data-validation-length="14" data-validation-error-msg="&amp;nbsp;">
	                                        </div><br>
	                                        <div class="form__input form__input--small">
...
<!-- 	                                <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
	                                  ...
	                                  <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago PagoEfectivo.
	                                    <form class="form" id="form_recharge_pagoefectivo" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_pagoefectivo_efectivo" tabindex="160" maxlength="4" data-validation="number" data-validation-allowing="range[40;3000]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
	                                ...
	                                <p class="subcontent-link"><a class="link link__arrow link_red_new" href="https://ubicanos.pagoefectivo.pe/" data-name="Decide - Cargar Saldo" data-category="Recarga fisica-Decide" data-action="click" data-label="Cargar saldo - tab pagoefectivo - ver lugares" target="_blank">Ver lugares</a></p>
	                                <p class="subcontent-link" style="padding-bottom: 20px;"><a class="link link__play link_red_new" href="https://pagoefectivo.pe/como-pagar.html" data-name="Decide - Cargar Saldo" data-category="Recarga fisica-Decide" data-action="click" data-label="Cargar saldo - tab pagoefectivo - como funciona" target="_blank">¿Cómo funciona?</a></p>
	                                  ...
	                                  <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago SafetyPay.
	                                    <form class="form" id="form_recharge_safetypay" autocomplete="off">
	                                      ...
	                                      <div class="form__input form__input--small">
	                                        ...
	                                        <input type="text" name="monto" id="monto_safetypay_efectivo" tabindex="170" maxlength="4" data-validation="number" data-validation-allowing="range[80;3000]" data-validation-error-msg="&amp;nbsp;">
	                                      </div><br>
	                                      <div class="form__input form__input--small">
...
<!-- 	                            </div> -->
	                  ...
	                  <p class="recharge__body-legal"><a id="footer-term-deprecated" style="cursor: pointer;" class="link link__base link_red_new" href="<%=Constants.URL_QW%>/terminos-y-condiciones/" target="_blank">Términos del uso del saldo virtual</a></p>
	                </div>
	              </div>
	            </div>
	          </div>
