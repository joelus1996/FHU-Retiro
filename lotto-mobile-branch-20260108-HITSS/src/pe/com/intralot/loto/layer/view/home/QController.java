...
public class QController {
	...
	//static final Log logger = LogFactory.getLog(QController.class);    

	@SuppressWarnings("rawtypes")
	@RequestMapping("/q-noactivo")	
	public ModelAndView showMenu(HttpServletRequest request, ModelMap objectModelMap) throws Exception {
		...
		if(StringUtils.isEmpty(phoneNumber)){
			...
			return new ModelAndView("home/interface-qr");	
			
		} catch (Exception e) {
			LoggerApi.severe(e);
			return new ModelAndView("home/interface-qr");
		}finally {
			//LoggerApi.Log.info("Salir al metodo: HomeQr. Estado : Satisfactorio");
			//LoggerApi.Log.info("Salir al action: QController.");
		}
		}
