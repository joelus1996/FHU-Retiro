...
@Entity
@NamedNativeQuery(name = "BALANCESALE_GETBALANCELIST", query = "{ call LOTOCARD.BALANCESALE.GETBALANCELIST(?,?) }", callable = true, resultClass = ClientProcedureGetBalanceList.class)
public class ClientProcedureGetBalanceList {
