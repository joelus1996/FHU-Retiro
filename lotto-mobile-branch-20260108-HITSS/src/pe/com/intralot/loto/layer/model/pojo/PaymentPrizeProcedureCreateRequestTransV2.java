...
@Entity
@NamedNativeQuery(
		name = "PRIZE_PAYMENT_CREATE_REQUEST_TRANS_V2",
		query = "{ call LOTOCARD.PRIZE_PAYMENT.CREATE_REQUEST_TRANS(?,?,?,?,?,?,?,?,?,?,?,?,?,?) }",
		callable = true,
		resultClass = PaymentPrizeProcedureCreateRequestTransV2.class
		)
public class PaymentPrizeProcedureCreateRequestTransV2 {
