...
@Entity
@NamedNativeQuery(
		name = "TINKASALE_BET_DATA", 
		query = "{ call LOTOCARD.LOTTOMOBILE.BET_DATA_TINKA_2(?,?) }", 
		callable = true, 
		resultClass = TinkaSale.class)
public class TinkaSale {
	...
	@Column(name="w_siosi")
	private String lastSiosi;
	
	@Column(name="w_numbers_more")
	private String numberMore;
	...
	public String getNumberMore() {
		return numberMore;
	}
	public void setNumberMore(String numberMore) {
		this.numberMore = numberMore;
	}
	...
	public String getLastSiosi() {
		return lastSiosi;
	}
	public void setLastSiosi(String lastSiosi) {
		this.lastSiosi = lastSiosi;
	}
	...
	public void setThirdMonths(Integer tirdMonths) {
		this.thirdMonths = tirdMonths;
	}
	public Integer getThirdDraws() {
		return thirdDraws;
	}
	public void setThirdDraws(Integer tirdDraws) {
		this.thirdDraws = tirdDraws;
	}
	public Double getThirdDiscount() {
		return thirdDiscount;
	}
	public void setThirdDiscount(Double tirdDiscount) {
		this.thirdDiscount = tirdDiscount;
	}
	...
	public Map<String, String> toMap(){
		...
		map.put("pozo", ((prize!=null && prize!=0)?util.formatCurrency2(prize):""));
		...
		map.put("lastSiosi", ((lastSiosi!=null && !lastSiosi.equals(""))?lastSiosi:""));
	...
	public String toString(){
		return " status:"+status+" message:"+message+" prize:"+prize+" activeDraw:"+activeDraw+" closeDate:"+closeDate
				...
				+" numberMore:"+numberMore+" numbersLess:"+numbersLess+" priceType:"+priceType
				...
				+" thirdMonths:"+thirdMonths+" thirdDiscount:"+thirdDiscount+" thirdDraws:"+thirdDraws+" drwid:"+drwid
				+" balanceAmount:"+balanceAmount+" balanceAmountGame:"+balanceAmountGame+" otherAmount:"+otherAmount;
	}
