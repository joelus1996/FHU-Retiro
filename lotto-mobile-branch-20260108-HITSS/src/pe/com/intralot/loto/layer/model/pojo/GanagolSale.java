...
@Entity
@NamedNativeQuery(
		name = "GANAGOLSALE_BET_DATA", 
		query = "{ call LOTOCARD.LOTTOMOBILE.BET_DATA_GANAGOL_2(?,?) }", 
		callable = true, 
		resultClass = GanagolSale.class)
public class GanagolSale {
	...
	@Column(name="w_promotion_message")
	...
	public String toString(){
		return " status:"+status+" message:"+message+" prize:"+prize+" activeDraw:"+activeDraw+" closeDate:"+closeDate
				...
				+" notes:"+notes+" priceType:"+priceType
				...
				+" lastDraw:"+lastDraw+" lastPrize:"+lastPrize+" lastCloseHour:"+lastCloseHour
				+" lastCloseDate:"+lastCloseDate+" promotionMessage:"+promotionMessage
