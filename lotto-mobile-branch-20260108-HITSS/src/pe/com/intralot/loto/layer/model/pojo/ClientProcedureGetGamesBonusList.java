...
@Entity
@NamedNativeQuery(
		name = "BALANCESALE_GETOTHERLISTQUANTITY", 
		query = "{ call LOTOCARD.BALANCESALE.GETOTHERLISTQUANTITY(?,?) }", 
		callable = true, 
		resultClass = ClientProcedureGetGamesBonusList.class
		)

public class ClientProcedureGetGamesBonusList {
