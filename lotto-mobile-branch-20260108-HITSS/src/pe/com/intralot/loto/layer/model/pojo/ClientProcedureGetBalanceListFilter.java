...
@Entity
@NamedNativeQuery(name = "BALANCESALE_GETBALANCELIST_FILTER", query = "{ call LOTOCARD.BALANCESALE.GETBALANCELISTFILTER(?,?,?,?) }", callable = true, resultClass = ClientProcedureGetBalanceListFilter.class)
public class ClientProcedureGetBalanceListFilter {
