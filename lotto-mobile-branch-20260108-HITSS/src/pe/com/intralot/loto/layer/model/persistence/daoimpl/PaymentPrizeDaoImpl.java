...
import pe.com.intralot.loto.layer.model.pojo.PaymentPrizeProcedureGenerateTokenPurchaseNumber;
...
public class PaymentPrizeDaoImpl extends HibernateBaseDaoImpl implements PaymentPrizeDao{
	...
	public PaymentPrizeProcedureGetDataCollectPrizes getDataCollectPrizes(Integer clientId) throws Exception {
        ...
        if (objectDomain != null) {
            LoggerApi.Log.info("getDataCollectPrizes o_client_id=" + objectDomain.getClientId() + 
            		...
            		" o_saldo_liquidableCompleto=" + objectDomain.getSaldoLiquidableCompleto() +
	...
	public PaymentPrizeProcedureCreateRequest createRequest(String clientId, Double amount, String ip,
		...
		LoggerApi.Log.info("createRequest idClient=" + clientId +" amount="+amount+" ip="+ip+" paymentType="+paymentType+" plataform="+plataform+" loadedImge="+loadedImge);
	...
	public PaymentPrizeProcedureCreateRequestAutomatic createRequestAutomatic(String clientId, Double amount, String ip,
			String paymentType, String plataform, String imageDNI, String loadedImge) throws Exception {
		LoggerApi.Log.info("createRequestAutomatic idClient=" + clientId +" amount="+amount+" ip="+ip+" paymentType="+paymentType+" plataform="+plataform+" loadedImge="+loadedImge);
	...
	@Override
	public PaymentPrizeProcedureCreateRequestTrans createRequestTrans(String clientId, Double amount, String ip, 
        ...
        if (objectDomain != null) {
            LoggerApi.Log.info("createRequestTrans idClient=" + clientId +" amount="+amount+" ip="+ip+" paymentType="+paymentType +" plataform="+plataform+" guardarRecurrente="+guardarRecurrente+" rango="+rango+
            		" banco="+banco+" cuenta="+cuenta+" departamento="+departamento+" s_message="+objectDomain.getMessage()+ " o_amount="+objectDomain.getAmount()+" o_request_number="+objectDomain.getRequestNumber());
        }
		return objectDomain;
	}
	
	@Override
	public PaymentPrizeProcedureCreateRequestTransV2 createRequestTransV2(String clientId, Double amount, String ip, 
			String paymentType, String plataform, String imageDNI, String loadedImge, String banco, String cuenta,
			String departamento, String idBanco, String guardarRecurrente, String rango) throws Exception {
		LoggerApi.Log.info("createRequestTrans idClient=" + clientId +" amount="+amount+" ip="+ip+" paymentType="+paymentType+" plataform="+plataform+" loadedImge="+loadedImge+" banco="+banco+" cuenta="+cuenta+" departamento="+departamento+" guardarRecurrente="+guardarRecurrente+" rango="+rango);
		List<PaymentPrizeProcedureCreateRequestTransV2> resultQuery = new ArrayList<PaymentPrizeProcedureCreateRequestTransV2>();
		PaymentPrizeProcedureCreateRequestTransV2 objectDomain = new PaymentPrizeProcedureCreateRequestTransV2();
        ...
        values[11] = guardarRecurrente;
        values[12] = rango;
        resultQuery = super.findForNamed("PRIZE_PAYMENT_CREATE_REQUEST_TRANS_V2", values);
        objectDomain = DataAccessUtils.uniqueResult(resultQuery);
        if (objectDomain != null) {
            LoggerApi.Log.info("createRequestTrans idClient=" + clientId +" amount="+amount+" ip="+ip+" paymentType="+paymentType +" plataform="+plataform+" guardarRecurrente="+guardarRecurrente+" rango="+rango+
            		" banco="+banco+" cuenta="+cuenta+" departamento="+departamento+" s_message="+objectDomain.getMessage()+ " o_amount="+objectDomain.getAmount()+" o_request_number="+objectDomain.getRequestNumber());
	...
	public PaymentPrizeProcedureGetRequestByNumber getRequestByNumber(Object[] values) throws Exception {
		LoggerApi.Log.info("getRequestByNumber requestNumber="+values[0]);		
		List<PaymentPrizeProcedureGetRequestByNumber> resultQuery = new ArrayList<PaymentPrizeProcedureGetRequestByNumber>();
		PaymentPrizeProcedureGetRequestByNumber objectDomain = new PaymentPrizeProcedureGetRequestByNumber();
		resultQuery = super.findForNamed("PRIZE_PAYMENT_GET_REQUEST_BY_NUMBER", values);
	    objectDomain = DataAccessUtils.uniqueResult(resultQuery);
	    if (objectDomain != null) {
	    	LoggerApi.Log.info("getRequestByNumber requestNumber="+objectDomain.getRequestNumber()+" clientId="+objectDomain.getClientId());
	    }
		return objectDomain;
	}
	...
	public PaymentPrizeProcedureUpdateTokenCard updateTokenCard(Object[] values) throws Exception {
		LoggerApi.Log.info("updateTokenCard clientId="+values[0]);		
		List<PaymentPrizeProcedureUpdateTokenCard> resultQuery = new ArrayList<PaymentPrizeProcedureUpdateTokenCard>();
		PaymentPrizeProcedureUpdateTokenCard objectDomain = new PaymentPrizeProcedureUpdateTokenCard();
		resultQuery = super.findForNamed("PRIZE_PAYMENT_UPDATE_TOKEN_CARD", values);
	    objectDomain = DataAccessUtils.uniqueResult(resultQuery);
	    if (objectDomain != null) {
	    	LoggerApi.Log.info("updateTokenCard message="+objectDomain.getMessage()+" state="+objectDomain.getState());
	    }
		return objectDomain;
	}
	...
	public PaymentPrizeProcedureGetTokenCard getTokenCard(Object[] values) throws Exception {
		LoggerApi.Log.info("getTokenCard clientId="+values[0]);		
		List<PaymentPrizeProcedureGetTokenCard> resultQuery = new ArrayList<PaymentPrizeProcedureGetTokenCard>();
		PaymentPrizeProcedureGetTokenCard objectDomain = new PaymentPrizeProcedureGetTokenCard();
		resultQuery = super.findForNamed("PRIZE_PAYMENT_GET_TOKEN_CARD", values);
	    objectDomain = DataAccessUtils.uniqueResult(resultQuery);
		return objectDomain;
	}
