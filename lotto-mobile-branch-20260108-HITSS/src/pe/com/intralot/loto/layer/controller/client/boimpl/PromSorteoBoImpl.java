...
public class PromSorteoBoImpl implements PromSorteoBo{
	...
	public int getByIdClient(HttpSession session) {
		...
		return session.getAttribute("clientId") != null ? Integer.parseInt(session.getAttribute("clientId").toString().trim()) : 0 ;
