...
public class AuthenticationQTTrx {
	...
	public static String SERVER  			 = Constantes.CASINO_QT_API_URL; 
	public static String USERNAME  			 = Constantes.CASINO_QT_USERNAME;
	public static String PASSWORD  			 = Constantes.CASINO_QT_PASSWORD;  
