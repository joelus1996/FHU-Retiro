...
public class GetResultKyc {
	...
	public static String SERVER  			 = Constantes.KYC_API_URL; 
	public static String USERNAME  			 = Constantes.KYC_USERNAME;
	public static String PASSWORD  			 = Constantes.KYC_PASSWORD;  
