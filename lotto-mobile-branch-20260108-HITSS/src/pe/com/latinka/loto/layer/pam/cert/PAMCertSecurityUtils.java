...
import pe.com.intralot.loto.utils.*;
	...
	public ResultBean putSmsClient(Integer p_clientId,String number,SecurityLoginBo beanSecurityLoginBo) {
    	...
    	try {
    		...
    		if(result!=null && result.getCode() !=null && result.getCode()==200 && result.getStatus()==1) {
    			...
    			message = "El c&oacute;digo de activaci&oacute;n no ha sido procesado. Intente ingresar a su cuenta m&aacute;s tarde.";
    		}
        } catch (Exception e) {
...
//	  }
	  ...
	  if (parameters) {
	      ...
	      jdata.addProperty("playerIp", PAMCertSecurityUtils.getClientIp(request));
