			...
			<div class="content">
				<section class="main-section">
					<div class="main-actions map-actions">
						<div class="row">
							<div class="main-action w-50 br-white">
								<a href="#" class="tablink actived" data-id="map">MAPA</a>
							</div>
							<div class="main-action w-50">
								<a href="#" class="tablink" data-id="list">LISTA</a>
							</div>
						</div>
					</div>
					<div class="map-body">
						...
						<div class="map-view" id="list" style="overflow-y: auto;">
