...
<meta name='description' content='Super 3, resultado de sorteos anteriores ' />
    ...
    <ul style="margin-right: 5px; margin-left: 5px;" class="listContent listContentCuadro">	
      <c:forEach	var="item"  items="${getListResult}">	     
		<li class="arrow">							      
		   ...
		   sorteo ${item.drwid} : ${item.date} <BR>
		   Super3: ${item.result}		
		   </div> 			
		</li>	
		</c:forEach>	    
