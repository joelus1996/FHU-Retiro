...
public interface ClientBalanceDao {	
	...
	//public List<ClientBalance> finByPk(Integer pk) throws Exception;
	
	public List<ClientProcedureGetBalanceList> finByPk(Integer pk) throws Exception;
	
	public List<ClientProcedureGetTeApuestoPromoList> findTeApuestoPromoByPk(Integer pk) throws Exception;
	
	public List<ClientProcedureGetBicolorPromoList> findBicolorPromoByPk(Integer pk) throws Exception;
	
	public List<ListTicketBicolorClient> getListBicolorTickets(Integer pk) throws Exception;
	
	public List<ClientProcedureGetTeApuestoBonusList> findTeApuestoBonusByPk(Integer pk) throws Exception;
	
	public List<ClientProcedureGetGamesBonusList> findGamesBonusByPk(Integer pk) throws Exception;
	...
	public List<ClientProcedureGetBalanceListFilter> finByBalanceFilter(Integer p_clientId , String start_date, String end_date) throws Exception;
}