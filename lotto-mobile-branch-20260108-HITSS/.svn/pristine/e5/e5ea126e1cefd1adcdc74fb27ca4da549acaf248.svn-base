...
@Entity
@NamedNativeQuery(
		name = "YAPE_PLIN_VERIFY_TRANSACTION",
		query = "{ call LOTOCARD.transactionpefectivo.verify_transaction(?,?,?) }",
		callable = true,
		resultClass = ProcedureYapePlinVerifyTransaction.class
		)
public class ProcedureYapePlinVerifyTransaction {
