...
<!-- <body class="main-copaentucasa"> -->
	...
	<div class="container">	
		...
		<div class="content-wrap">		
			<div class="content">
				<img src="${rutaAvionPeru}/home-mobile-peru.png" style="display: block;margin-left: auto;margin-right: auto;width: 100%;" alt="Avión del Hincha Eliminatorias 2026">			
				<section class="main-section">									
					<div class="main-game avion-qatar">
						<h2 >¡Participa con tus jugadas desde S/ 10!</h2>
					...
					<div class="copa-opciones">
							...
							<c:if test="${!empty clientId}">							
								<div>
									<button style=" color: #ffffff" type="button" id="${btnRegistrar}" onclick="return false;"class="button-avion-qatar-naranja">Sí quiero</button>
								</div><br>
							</c:if>
							<c:if test="${empty clientId}">
								<div>
									<button type="button" id="${btnSecurityLogin}" onclick="return false;"class="button-avion-qatar-naranja">Sí quiero</button>
								</div><br>
							</c:if>
							<div style="background: #ffffff;" class="f_linea-copabicolor"></div>
							<div>
								<button type="button" id="${btnComoParticipar}" onclick="return false;"class="button-avion-qatar-blanco">¿Cómo participar?</button>
							</div>
