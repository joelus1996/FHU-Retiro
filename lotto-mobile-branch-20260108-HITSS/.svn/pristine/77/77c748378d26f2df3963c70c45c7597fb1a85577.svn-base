...
<head>
	...
	<title>Gana Diario : Jugada</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<link rel="stylesheet" href="layer-view-style/v2/styles.css?v=<%=Constantes.styles_css%>" type="text/css" />
	<meta name="description" content="Gana Diario móvil, realiza una jugada consecutiva" />
			...
			<div class="content">
				<section class="main-section">
					<div class="main-game">
						...
						<form action="game_ganadiario_add_consecutive.html" method="post" id="game_ganadiario_add_consecutive">

							<div class="boxes-lots boxes-no-padding">

								<c:forEach 	var="item"  items="${consecutiveGanadiarioList}">
...
<!-- 								<button type="button" id="addConsecutiveGanadiario" class="btn btn-red">CONTINUAR</button><br> -->
								<button type="button" id="addConsecutiveGanadiario" class="btn btn-red float-bottom">CONTINUAR</button>
