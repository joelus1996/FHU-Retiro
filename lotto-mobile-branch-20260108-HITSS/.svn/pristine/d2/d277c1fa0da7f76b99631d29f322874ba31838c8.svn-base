      ...
      <div class="body__content">
        <div class="registro">
          ...
          <div class="content">
            ...
            <div class="registro__form" style="padding-top: 0px;">
              <form class="form" autocomplete="off" action="client_lotocard_register_form.html" method="post" id="client_lotocard_register_form" data-response-type="json">
                ...
                <div class="form__input form__optional show"   id="divNumberDoc">
                  ...
                  <div class="form-doc-message" id='numberDoc_msg' >ESTE DATO SERÁ USADO COMO TU USUARIO</div>
                </div>
                <div class="form__input form__optional" id="div-documento-pasap">
                  ...
                  <div class="form-doc-message" id='documento_pasap_msg' >ESTE DATO SERÁ USADO COMO TU USUARIO</div>
                </div>
                <div class="form__input form__optional" id="div-documento-carex">
                  ...
                  <div class="form-doc-message" id='documento_carex_msg' >ESTE DATO SERÁ USADO COMO TU USUARIO</div>
                </div>
<!--                 <div id='document_msg' style="margin-top: 6px; margin-bottom: 7px;font-size:10px;color:#07663a;font-weight: bold">ESTE DATO SERÁ USADO COMO TU USUARIO</div> -->
                <div class="form__input">
                  ...
                  <div id='name_msg' style="margin-top: 17px; font-size:10px;color:#07663a; font-weight: bold"></div>	
                  
                </div>
                <div class="form__input" style="margin-top: 50px; margin-bottom: 5px;">
                  ...
                  <div id='last_name_msg' style="margin-top: 17px; font-size:10px;color:#07663a; font-weight: bold"></div>	
         
                </div>
                <div class="form__select form__select4" style="margin-top: 50px; margin-bottom: 5px;">
                  <label for="nacionalidad">Nacionalidad</label>
                  <select name="nacionalidad" id="nacionalidad" tabindex="20" data-validation="required" data-validation-error-msg="Seleccionar tu nacionalidad" style="width: 100%;">
<!--                    <option value="" selected>Nacionalidad</option> -->
                  </select>
                </div>
                <div class="form__input form__input-calendar"style="margin-top: 20px; margin-bottom: 5px;">
                  ...
                  <div id='dateBirth_msg' style="margin-top: 17px; font-size:10px;color:#07663a;font-weight: bold"></div>	
                
                </div>
                <div class="form__section" style="margin-top: 53px; margin-bottom: 5px;">Datos de acceso</div>
<!--                 <div class="form__input"> -->
...
<!--                 </div> -->
                ...
                <div class="form__input">
                  ...
                  <input type="tel" name="mobilePhone" id="mobilePhone" tabindex="18" maxlength="9" data-validation="length number" data-validation-length="9" data-validation-allowing="range[900000000;999999999]" data-validation-error-msg="Tu celular es requerido">
                </div>
                <div class="form__input">
