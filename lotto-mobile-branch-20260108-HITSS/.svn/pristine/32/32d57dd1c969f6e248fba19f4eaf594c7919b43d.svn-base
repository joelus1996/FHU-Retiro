...
import pe.com.intralot.loto.utils.Labeler;
...
public final class  StringLib extends ConnectionFactory{
    ...
    * ENCRIPTA *
    ...
    public static String verifyEmail(String email) throws Exception {
        ...
        for (String s:list) {
            if (email.toLowerCase().contains(s.toLowerCase())) {
         	String message = "Ingresar una direcci&oacute;n de correo correcto";
	...
	public static String serializeHashMapArray(HashMap[] data) throws IOException {
    ...
    public static HashMap[] deserializeHashMapArray(String base64) throws IOException, ClassNotFoundException {
    ...
    public static HashMap[] toHashMapArray(Object sessionObj) {
        if (sessionObj instanceof List) {
            List<HashMap> list = (List<HashMap>) sessionObj;
            return list.toArray(new HashMap[0]);
        } else if (sessionObj instanceof HashMap[]) {
            return (HashMap[]) sessionObj;
        } else {
