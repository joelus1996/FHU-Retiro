...
@Entity
@NamedNativeQuery(name = "BALANCESALE_GETPROMOLIST", query = "{ call LOTOCARD.BALANCESALE.GETPROMOLIST2(?,?) }", callable = true, resultClass = ClientProcedureGetTeApuestoPromoList.class)
public class ClientProcedureGetTeApuestoPromoList {
