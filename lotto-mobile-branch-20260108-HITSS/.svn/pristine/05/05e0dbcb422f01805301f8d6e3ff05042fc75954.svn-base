...
<!-- End Google Tag Manager -->
	...
	<style type="text/css">		
		...
		.qr-download-btn {
		    background-color: #233db4 !important;
		    color: #fff !important;
...
<body>
	...
	<input type="hidden" id="autoexclusion" value="false" />
	
	<input type="hidden" id="urlAutocontrol" value="" />
                      ...
                      <div class="tabs__container-item" id="internet">
                        <ul class="accordion">
                          ...
                          <li id="accordion_bcp" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_bcp');">
                            	<img class="img-bcp" src="layer-view-image/client/logo-bcp.png">
                            	<span id="limitesRecargaBCP" style="padding-left: 90px; font-weight: 700; font-size: 11px;"></span>
                            </div>
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
                                ...
                                <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago BCP.
                                  <form class="form" action="data/recharge.json" id="form_recharge_bcp" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_bcp" tabindex="120" maxlength="5" data-validation="number" data-validation-allowing="range[0;0]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_bcp" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_bcp" tabindex="121" maxlength="20" disabled="true">
                                    </div>
                              ...
                              <p class="subcontent-link"><a class="link link__arrow" href="https://www.viabcp.com" data-name="Decide - Cargar Saldo" data-category="Recarga por Internet-Decide" data-action="click" data-label="Cargar Saldo - tab BCP - ir a BCP" target="_blank" style="color:#e30613; border-bottom: solid 1px #e30613;" onclick="datalayerIrEntidadBancaria(this);">Ir a BCP</a></p>
                          ...
                          <li id="accordion_interbank" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_interbank');">
                            	<img class="img-interbank" src="layer-view-image/client/logo-interbank.png">
                            	<span id="limitesRecargaInterbank" style="padding-left: 66px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
                              ...
                              <div class="subcontent-list">
                              	<form  class="form" id="form_recharge_ibk_i" autocomplete="off" style="padding: 0px 0;">
									...
									<div class="form__input form__input--small w40">
                                      ...
                                      <input class="codigo_promocional_ibk" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_ibk_i" tabindex="119" maxlength="20" >
                                    </div>
                                    <div class="form__gift">
						  ...
						  <!-- accordion bbva-->
                          <li id="accordion_bbva" style="display: none;">
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_bbva');">
                            	<img class="img-bcp" src="layer-view-image/client/logo-bbva.png">
                            	<span id="limitesRecargaBBVA" style="padding-left: 90px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
                              ...
                              <ol class="subcontent-list">
                                <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago BBVA.
                                  <form class="form" action="data/recharge.json" id="form_recharge_bbva" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga"  onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_bbva" tabindex="120" maxlength="5" data-validation="number" data-validation-allowing="range[0;0]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_bbva" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_bbva" tabindex="121" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar Saldo - tab BBVA - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
                                    <div class="form__alert_recharge"></div>
                                    <div class="form__button">
                                      <button class="button button__base button--small btn_red_new" type="submit" disabled data-label="Cargar Saldo - tab BBVA - generar codigo" onclick="tagginSaldoBBVAEEaddToCart()">Continuar</button>
                                    </div>
                                 
                                   	<div class="subcontent" style="padding:0px; margin-right: -17px; margin-left: -41px; border: none;">
										<table class="subcontent-table" id="grillaBBVA" style="margin-left:0px;width:100%;">
										</table>
									</div>
									
                                  </form>
                                  <template id="tpl-recharge-head-bbva">
                                    <tr>
                                      <th>Monto</th>
                                  ...
                                  <template id="tpl-recharge-item-bbva">
                                    <tr class="row_grid">
                                      <td>{{amount}}</td>
                                      <td>{{code}}</td>
                                      <td>{{date}}</td>
                              ...
                              <p class="subcontent-link"><a class="link link__arrow" href="https://www.bbva.pe" data-name="Decide - Cargar Saldo" data-category="Recarga por Internet-Decide" data-action="click" data-label="Cargar Saldo - tab BBVA - ir a BBVA" target="_blank" style="color:#e30613; border-bottom: solid 1px #e30613;" onclick="datalayerIrEntidadBancaria(this);">Ir a BBVA</a></p>
                              <div class="subcontent-footer">Verifica tu recarga en la sección "<strong>Movimientos</strong>"</div>
                            </div>
                          </li>
                                                                                                                       
                          <!-- accordion yape tupay-->
                          <li id="accordion_Yape_Tupay" style="display: none;">
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_Yape');">
                            	<img class="img-pagoefectivo" src="layer-view-image/client/yape2.png?v=2" style="width: 128px !important;">
                            	<span id="limitesRecargaYapeTupay" style="padding-left: 25px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent" style="padding-top: 0px;">
                              ...
                              <p class="subcontent-text" style="padding-top: 10px;">Recarga en YAPE desde S/<span id="amtMinRechargeYapeTupay"></span> hasta S/<span id="amtMaxRechargeYapeTupay"></span>.</p>
                              <p class="subcontent-text"><img class="subcontent-logo" src="layer-view-image/client/img_viatupay.png" alt="Banca_por_Internet" ></p>							
                              <ol class="subcontent-list">
                                <li>Ingresa el monto a recargar. Si tienes un código promocional, escríbelo y presionar "APLICAR" para hacerlo efectivo. <br>Luego genera tu código QR.
                                  <form class="form" action="data/recharge-yape.json" id="form_recharge_yape_tupay" autocomplete="off" style="padding-bottom: 0px;">
									...
									<input type="hidden" name="type_token" id="type_token_yape_tupay_i" value="1" />
                                    
                                    <div class="form__input form__input--small">
                                      <label for="monto_yape">Monto S/</label>
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_YapeTupay" tabindex="130" maxlength="5" data-validation="number" data-validation-allowing="range[15;500]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_yape" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_yape_tupay" tabindex="131" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                              ...
                              <header id="frame_yapetupayl" class="hide"  style="margin-left: -16px; width: 111%;">
									    <div class="embwrap">
									        <div class="embcell">
									            <div class="ifrwrap">
									                <div style="display: flex; flex-direction: column; align-items: center; text-align: center; width: 100%;">
									                	<!-- Total a pagar -->
												          <div tabindex="0" class="dp_payment" style= "margin-bottom: 10px">
												            <p class="dp_payment_total_amount">Total a pagar</p>
												            <div class="dp_payment_currency">
												              <b class="referenceTotal" id="amountYape" style= "color:#233db4; font-size: 40px; line-height: 100%">S/0</b>
												            </div>
												            <span class="dowload_wallet">Toma una captura de pantalla y págalo<br>desde tu billetera favorita.</span>
												          </div>
									                    <img id="qrImageYape" src="" alt="Código QR" style="width:270px;height:270px;display:block;margin-bottom: -20px;margin-top: -10px;">
												         <p class="label-expiration">
														    <span class="no-break">Válido hasta el&nbsp;</span>
														
														    <span class="expiration">
														        <span class="time" id="expirationDateYape"></span>
														        <span class="subtitle"></span>
														    </span>
														
														    <span class="break-before">&nbsp;hasta las&nbsp;</span>
														
														    <span id="expirationTimeYape"></span>
														</p>

<!-- 														<button type="button" class="qr-download-btn" id="downloadQrButtonYape"> -->
<!-- 														    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" -->
<!-- 														        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" -->
<!-- 														        style="margin-right:8px; width:16px; height:16px;"> -->
<!-- 														        <path fill="currentColor" d="M216 0h80c13.3 0 24 10.7 24 24v168h87.7c17.8 0 26.7 21.5 14.1  -->
<!-- 														        34.1L269.7 378.3c-7.5 7.5-19.8 7.5-27.3 0L90.1 226.1c-12.6-12.6-3.7-34.1 14.1-34.1H192V24 -->
<!-- 														        c0-13.3 10.7-24 24-24zm296 376v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V376c0-13.3  -->
<!-- 														        10.7-24 24-24h146.7l49 49c20.1 20.1 52.5 20.1 72.6 0l49-49H488c13.3 0 24 10.7 24 24z"> -->
<!-- 														        </path> -->
<!-- 														    </svg> -->
<!-- 														    DESCARGAR QR -->
<!-- 														</button> -->
							  ...
							  <button type="button" id="close_yapetupayl" class="btn btn-sm btn-black hide" style="margin-left: -16px; width: 111%;">CERRAR</button>
									                         
                              <div class="subcontent-footer" style="margin-top: 20px; display: none;" id="divVerificaRecargaYapeTupay">La carga de tu saldo puede demorar unos minutos. Para verificar que se realizó, 
                          ...
                          <!-- accordion plin tupay-->
                          <li id="accordion_Plin_Tupay" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_Plin');">
                            	<img class="img-pagoefectivo" src="layer-view-image/client/plin2.png?v=2" style="width: 128px !important;">
                            	<span id="limitesRecargaPlinTupay" style="padding-left: 25px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent" style="padding-top: 0px;">
                              <p class="subcontent-text" style="padding-top: 10px;">Recarga en PLIN desde S/<span id="amtMinRechargePlinTupay"></span> hasta S/<span id="amtMaxRechargePlinTupay"></span>.</p>
                              <p class="subcontent-text"><img class="subcontent-logo" src="layer-view-image/client/img_viatupay.png" alt="Banca_por_Internet" ></p>							
                              <ol class="subcontent-list">
                                <li>Ingresa el monto a recargar. Si tienes un código promocional, escríbelo y presionar "APLICAR" para hacerlo efectivo. <br>Luego genera tu código QR.
                                  <form class="form" action="data/recharge-plin.json" id="form_recharge_plin_tupay" autocomplete="off" style="padding-bottom: 0px;">
									...
									<input type="hidden" name="type_token" id="type_token_plin_tupay_i" value="1" />
                                    
                                    <div class="form__input form__input--small">
                                      <label for="monto_plin">Monto S/</label>
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_PlinTupay" tabindex="130" maxlength="5" data-validation="number" data-validation-allowing="range[15;500]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_plin" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_plin_tupay" tabindex="131" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                              ...
                              <header id="frame_plintupayl" class="hide" style="margin-left: -16px; width: 111%;">
								<div class="embwrap">
									<div class="embcell">
										<div class="ifrwrap">
											<div style="display: flex; flex-direction: column; align-items: center; text-align: center; width: 100%;">
									          ...
									          <div tabindex="0" class="dp_payment" style= "margin-bottom: 10px">
									            <p class="dp_payment_total_amount">Total a pagar</p>
									            <div class="dp_payment_currency">
									              <b class="referenceTotal" id="amountPlin" style= "color:#233db4; font-size: 40px; line-height: 100%">S/0.00</b>
									            </div>
									            <span class="dowload_wallet">Toma una captura de pantalla y págalo<br>desde tu billetera favorita.</span>
									            
									          </div>
									          
												<img id="qrImagePlin" src="" alt="Código QR" style="width:270px;height:270px;display:block;margin-bottom: -20px;margin-top: -10px;">
												<p class="label-expiration">
												    <span class="no-break">Válido hasta el&nbsp;</span>
												
												    <span class="expiration">
												        <span class="time" id="expirationDatePlin"></span>
												        <span class="subtitle"></span>
												    </span>
												
												    <span class="break-before">&nbsp;hasta las&nbsp;</span>
												
												    <span class="mr-4" id="expirationTimePlin"></span>
												</p>
<!-- 												<button type="button" class="qr-download-btn" id="downloadQrButtonPlin"> -->
<!-- 												    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" -->
<!-- 												        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" -->
<!-- 												        style="margin-right:8px; width:16px; height:16px;"> -->
<!-- 												        <path fill="currentColor" d="M216 0h80c13.3 0 24 10.7 24 24v168h87.7c17.8 0 26.7 21.5 14.1  -->
...
<!-- 												</button> -->
							  ...
							  <button type="button" id="close_plintupayl" class="btn btn-sm btn-black hide" style="margin-left: -16px; width: 111%;">CERRAR</button>
									                         
                              <div class="subcontent-footer" style="margin-top: 20px; display: none;" id="divVerificaRecargaPlinTupay">La carga de tu saldo puede demorar unos minutos. Para verificar que se realizó, 
                          ...
                          <!-- accordion yape pago efectivo -->
                          <li id="accordion_Yape" style="display: none;">
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_Yape');">
                            	<img class="img-pagoefectivo" src="layer-view-image/client/yape.png?v=1" style="width: 128px !important;">
                            	<span id="limitesRecargaYape" style="padding-left: 25px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent" style="padding-top: 0px;">
                              <div style="padding-top: 5px; padding-bottom: 4px; padding-left: 16px; background-color: #a90089; margin-left: -16px; margin-right: -16px; font-family: 'Roboto', sans-serif; font-size: 12px;" >
                              	<a href="https://az7pj.app.goo.gl/pruebaweb" target="_blank" style="color: white;" ><span class="icono-download"><span style="vertical-align: super; margin-left: 5px;">Descarga la app</span></span></a>
                              ...
                              <p class="subcontent-text"><img class="subcontent-logo" src="layer-view-image/client/pagoefectivo.png?v=2" alt="Banca_por_Internet" ></p>							                                                           
                              <ol class="subcontent-list">
                                <li>Ingresa el monto a recargar. Si tienes un código promocional, escríbelo y presionar "APLICAR" para hacerlo efectivo. <br>Luego genera tu código QR.
                                  <form class="form" action="data/recharge-yape.json" id="form_recharge_yape" autocomplete="off" style="padding-bottom: 0px;">
                                    ...
                                    <div class="form__input form__input--small">
                                      <label for="monto_yape">Monto S/</label>
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_yape" tabindex="130" maxlength="4" data-validation="number" data-validation-allowing="range[15;500]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_yape" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_yape" tabindex="131" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar Saldo - tab yape - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
                              ...
                              <div class="subcontent-footer" style="margin-top: 20px; display: none;" id="divVerificaRecargaYape">La carga de tu saldo puede demorar unos minutos. Para verificar que se realizó, 
                          ...
                          <!-- accordion plin pago efectivo-->
                          <li id="accordion_Plin" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_Plin');">
                            	<img class="img-pagoefectivo" src="layer-view-image/client/plin.png?v=1" style="width: 128px !important;">
                            	<span id="limitesRecargaPlin" style="padding-left: 25px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent" style="padding-top: 0px;">
                              ...
                              <p class="subcontent-text"><img class="subcontent-logo" src="layer-view-image/client/pagoefectivo.png?v=1" alt="Banca_por_Internet" ></p>							
                              <ol class="subcontent-list">
                                <li>Ingresa el monto a recargar. Si tienes un código promocional, escríbelo y presionar "APLICAR" para hacerlo efectivo. <br>Luego genera tu código QR.
                                  <form class="form" action="data/recharge-plin.json" id="form_recharge_plin" autocomplete="off" style="padding-bottom: 0px;">
                                    ...
                                    <div class="form__input form__input--small">
                                      <label for="monto_plin">Monto S/</label>
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_plin" tabindex="130" maxlength="4" data-validation="number" data-validation-allowing="range[15;500]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_plin" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_plin" tabindex="131" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar Saldo - tab plin - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
                              ...
                              <div class="subcontent-footer" style="margin-top: 20px; display: none;" id="divVerificaRecargaPlin">La carga de tu saldo puede demorar unos minutos. Para verificar que se realizó, 
                          ...
                          <li id="accordion_pagoefectivo" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_pagoefectivo');">
                            	<img class="img-pagoefectivo" src="layer-view-image/client/pagoefectivo.png?v=1" style="width: 104px;">
                            	<span id="limitesRecargaPEFE" style="padding-left: 49px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
                                ...
                                <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago PagoEfectivo.
                                  <form class="form" action="data/recharge-pagoefectivo.json" id="form_recharge_pagoefectivo" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_pagoefectivo" tabindex="130" maxlength="4" data-validation="number" data-validation-allowing="range[40;3000]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_pagoefectivo" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_pagoefectivo" tabindex="131" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
						...
						<li id="accordion_agora" style="display: none;">
                          <div class="accordion__title" onclick="datalayerMetodoPago('accordion_agora');">
							<img class="img-agora" src="layer-view-image/client/logo-agora2.png?v=1">
							<span id="limitesRecargaAgora" style="padding-left: 89px; font-weight: 700; font-size: 11px;"></span>
						</div>
							<div class="subcontent" style="padding-top: 0px;">
								<div style="padding-top: 5px; padding-bottom: 4px; padding-left: 16px; background-color: #00cdff; margin-left: -16px; margin-right: -16px; font-family: 'Roboto', sans-serif; font-size: 12px;" >
									<a href="https://app.agora.pe/oh-pay" target="_blank" style="color: #5A5A5A;" ><span class="icono-download"><span style="vertical-align: super; margin-left: 5px;">Descarga la app</span></span></a>
								</div>
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
							...
							<li style="margin-bottom: 0px;">Ingresa el monto a recargar. Si tienes un código promocional, escríbelo ahora, y presiona "APLICAR" para hacerlo efectivo.
								<form class="form" style="padding-bottom: 0px;" action="data/recharge.json" id="form_recharge_agora" autocomplete="off">
									...
									<div class="form__input form__input--small">
										...
										<input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_agora" tabindex="115" maxlength="4" data-validation="number" data-validation-allowing="range[10;1000]" data-validation-error-msg="&amp;nbsp;">
									</div><br>
									<div class="form__input form__input--small w40">
										<label for="codigo_agora" name="lblCodPromo">Código prom.</label>
										<input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_agora" tabindex="116" maxlength="20" disabled="true">
									</div>
									<div class="form__gift">
									...
									<div class="form__button">
										<div id="seccion_agora_confirmada" style="display: none;">
											...
											<button class="button button__base button--small btn_red_new" id="btnRecargaAgora" style="margin-bottom: 18px;" type="submit" disabled data-label="Cargar Saldo - tab AGORA - generar codigo" onclick="tagginSaldoAgoraEEaddToCart()">Recargar</button>
										</div>
									</div>							
                                  	</form>
                                </li>
                          ...
                          <!-- accordion izipay-->
                          <li id="accordion_izipay" style="display: none;">
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_izipay');">
                            	<img class="img-visanet" src="layer-view-image/client/logo-visa-mc.png">
                            	<span id="limitesRecargaIzipay" style="padding-left: 67px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
                              ...
                              <ol class="subcontent-list">
                                ...
                                <li>Luego haz clic en "Cargar" para ingresar tu tarjeta.
                                  <form class="form" action="data/recharge.json" id="form_recharge_izi" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_izi" tabindex="117" maxlength="5" data-validation="number" data-validation-allowing="range[10;1000]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_izi" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_izi" tabindex="118" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar Saldo - tab IZIPAY - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
                                    <div class="form__alert_recharge"></div>
                                   
                                    <div class="form__button">
                                      <button class="button button__base button--small btn_red_new" type="submit" disabled data-label="Cargar Saldo - tab IZIPAY - generar codigo" onclick="tagginSaldoEEaddToCart()">Cargar</button>
                                    </div>							
                                  </form>
                                </li>
                              </ol>
                          ...
                          <li id="accordion_visanet" style="display: none;">
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_visanet');">
                            	<img class="img-visanet" src="layer-view-image/client/logo-visa-mc.png">
                            	<span id="limitesRecargaVisa" style="padding-left: 40px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
                              <p class="subcontent-text"><strong>Con tu tarjeta de crédito o débito VISA y/o MasterCard:</strong></p>
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
                                ...
                                <li>Luego haz clic en "Cargar" para ingresar tu tarjeta VISA y/o Mastercard.
                                  <form class="form" action="data/recharge.json" id="form_recharge_visanet" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_visanet" tabindex="117" maxlength="4" data-validation="number" data-validation-allowing="range[10;1000]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_visanet" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_visanet" tabindex="118" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                          ...
                          <li  id="accordion_safetypay" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_safetypay');">
                            	<img class="img-safetypay" src="layer-view-image/client/logo-safety-pay.png">
                            	<span id="limitesRecargaSPAY" style="padding-left: 50px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
                                ...
                                <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago SafetyPay.
                                  <form class="form" action="data/recharge-safetypay.json" id="form_recharge_safetypay" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_safetypay" tabindex="140" maxlength="4" data-validation="number" data-validation-allowing="range[80;3000]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_safetypay" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_safetypay" tabindex="141" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                      ...
                      <div class="tabs__container-item" id="efectivo">
                        <ul class="accordion">
                          ...
                          <li id="accordion_efectivo_interbank" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_efectivo_interbank');">
                            	<img class="img-interbank" src="layer-view-image/client/logo-interbank.png">
                            	<span id="limitesRecargaEfeInterbank" style="padding-left: 40px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
                              ...
                              <div class="subcontent-list">
                              	<form  class="form" id="form_recharge_ibk_e" autocomplete="off" style="padding: 0px 0;">									
									...
									<div class="form__input form__input--small w40">
                                      ...
                                      <input class="codigo_promocional_ibk" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_ibk_e" tabindex="190" maxlength="20">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar Saldo - tab IBK - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
                          ...
                          <li id="accordion_efectivo_lotocard" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_efectivo_lotocard');"><strong>Lotocard</strong></div>
                            <div class="subcontent">
                                  ...
                                  <li>Digita el código PIN de 14 dígitos de tu Lotocard. <br>Si tienes un código promocional aplícalo ahora. <br>Luego, haz click en el botón "Cargar".
                                    <form class="form" action="data/recharge-lotocard.json" id="form_recharge_lotocard" autocomplete="off">
                                      ...
                                      <div class="form__input form__input--small">
                                        ...
                                        <input onfocusout="datalayerCodigoLotocard(this);" type="tel" name="lotocard" id="lotocard" tabindex="150" maxlength="14" data-validation="length number" data-validation-length="14" data-validation-error-msg="&amp;nbsp;">
                                      </div><br>
                                      <div class="form__input form__input--small w40">
                                        <label for="codigo_lotocard" name="lblCodPromo">Código prom.</label>
                                        <input class="codigo_promocional"  oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_lotocard" tabindex="151" maxlength="20" disabled="true">
                                      </div>
                                      <div class="form__gift">
...
<!--                                   </tr> -->
                          ...
                          <li id="accordion_efectivo_pagoefectivo" style="display: none;">
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_efectivo_pagoefectivo');">
                            	<img class="img-pagoefectivo" src="layer-view-image/client/pagoefectivo.png?v=1" style="width: 93px">
                            	<span id="limitesRecargaEfePEFE" style="padding-left: 33px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
...
<!--                               <p class="subcontent-text"><strong>¿Cómo Recargar?</strong></p> -->
                                ...
                                <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago PagoEfectivo.
                                  <form class="form" action="data/recharge-pagoefectivo.json" id="form_recharge_pagoefectivo" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_pagoefectivo_efectivo" tabindex="160" maxlength="4" data-validation="number" data-validation-allowing="range[40;3000]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_pagoefectivo_efectivo" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_pagoefectivo_efectivo" tabindex="161" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar saldo - tab pagoefectivo - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
                          ...
                          <li id="accordion_efectivo_safetypay" style="display: none;" >
                            <div class="accordion__title" onclick="datalayerMetodoPago('accordion_efectivo_safetypay');">
                            	<img class="img-safetypay" src="layer-view-image/client/logo-safety-pay.png">
                            	<span id="limitesRecargaEfeSPAY" style="padding-left: 50px; font-weight: 700; font-size: 11px;"></span>
                            </div>
                            <div class="subcontent">
                                ...
                                <li>Ingresa el monto que deseas recargar. <br>Si tienes un código promocional aplícalo ahora. <br>Luego genera tu código de pago SafetyPay.
                                  <form class="form" action="data/recharge-safetypay.json" id="form_recharge_safetypay" autocomplete="off">
                                    ...
                                    <div class="form__input form__input--small">
                                      ...
                                      <input class="monto_recarga" onfocusout="datalayerIngresarMonto(this);" type="tel" name="monto" id="monto_safetypay_efectivo" tabindex="170" maxlength="4" data-validation="number" data-validation-allowing="range[80;3000]" data-validation-error-msg="&amp;nbsp;">
                                    </div><br>
                                    <div class="form__input form__input--small w40">
                                      <label for="codigo_safetypay_efectivo" name="lblCodPromo">Código prom.</label>
                                      <input class="codigo_promocional" oninput="this.value = this.value.toUpperCase();" onfocusout="datalayerCodigoPromo(this);" type="text" name="codigo" id="codigo_safetypay_efectivo" tabindex="171" maxlength="20" disabled="true">
                                    </div>
                                    <div class="form__gift">
                                      <button class="button button__outline button--small" type="button" data-action="data/validate.json" data-label="Cargar saldo - tab safetypay - aplicar código promocional">Aplicar</button><span class="form__gift-valid"><img src="layer-view-image/client/icon-valid.svg" width="16" height="16">Cod. correcto</span>
                                    </div>
...
<!--                           </li> -->
                  ...
                  <p class="recharge__body-legal"><a class="link link__base" href="<%= Constantes.URL_QW%>/terminos-y-condiciones/" target="_blank" id="agre_tyc_deprecated" style="color: #e30613; border-bottom: solid 1px #e30613;" onclick="datalayerTerminosSaldoVirtual();">Términos del uso del saldo virtual</a></p>
                </div>
              </div>
            </div>
          </div>
...
<!--       <footer class="footer">footer</footer> -->
	...
	<div id="popup-message-session" class="overlay">
		<div class="popup popup-sm recuperar-password">								
			<a class="close-popup " id="close-popup-session" onclick="closePopupCA()">&times;</a>
	...
	<script>
// 	    document.getElementById('downloadQrButtonYape').addEventListener('click', function() {
// 	        const qrImage = document.getElementById('qrImageYape');
// 	        const link = document.createElement('a');
// 	        link.href = qrImage.src;
// 	        link.download = 'codigo_qr_yape.png';
// 	        document.body.appendChild(link);
// 	        link.click();
// 	        document.body.removeChild(link);
// 	    });
	    
// 	    document.getElementById('downloadQrButtonPlin').addEventListener('click', function() {
// 	        const qrImage = document.getElementById('qrImagePlin');
// 	        const link = document.createElement('a');
// 	        link.href = qrImage.src;
// 	        link.download = 'codigo_qr_plin.png';
// 	        document.body.appendChild(link);
// 	        link.click();
// 	        document.body.removeChild(link);
// 	    });
...
//   		 }
      ...
      function closePopupCA(){
    		$('.overlay.opened').removeClass('opened');
    		$('body').removeClass('modal');
    		parent.parent.location.replace("tav2.html");
      }
    </script>
