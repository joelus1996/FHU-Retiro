			...
			<div class="content">
				<section class="main-section">
					<div class="main-game">
						...
						<a href="game_ganadiario_show_menu.html" id="game_ganadiario_show_menu">
						...
						<div class="game-desc min-desc">
							...
							<c:if test="${status == 'saldo'}">
								...
								<!-- a href="#" id="ganadiario-charge" class="btn btn-purple">RECARGA TU SALDO</a -->
								
								<c:if test="${sessionScope.tipoGanadiario == 'suscripcion'}">
									<button id="ganadiario-suscripcion-charge" class="btn btn-purple">RECARGA TU SALDO</button>
								</c:if>
								<c:if test="${sessionScope.tipoGanadiario != 'suscripcion'}">
									<button id="ganadiario-charge" class="btn btn-purple">RECARGA TU SALDO</button>
								</c:if>
							</c:if>
						</div>
							...
							<div class="wrapper-after-play">
								<div class="body-after-play">
									<div class="review-play">
										...
										<!-- a href="#" id="client_play_show_information" class="btn btn-purple">MIS JUGADAS</a -->
										<button id="client_play_show_information" class="btn btn-purple">MIS JUGADAS</button>
									</div>
							...
							<div class="wrapper-after-play">
								<div class="body-after-play">
									<div class="review-play">
										...
										<!-- a href="#" id="game_ganadiario_show_shoppingcart" class="btn btn-purple">VOLVER</a -->
										<button id="game_ganadiario_show_shoppingcart" class="btn btn-purple">VOLVER</button>
									</div>
								</div>
							</div>
						</c:if>
		...
		$(document).ready(function() {
			...
			if(tipoCompra==="combo"){
				if (estatus == "ok") {
					...
					taggingCombosGanadiarioCompraExitosa(numCombo);
					taggingCombosGanadiarioEEpurchase(numCombo,ticketIdCombo,precioCombo,sorteosCombo,bolillasCombo,tipoJugadaCombo);
					datalayerPurchase(jugadas,
							importPagar/jugadaActuales,
							importPagar,
							'GanaDiario-'+$("#ticketIdCombo").val(),
							"Combo_"+numCombo);
				}else{
					var alertPlay = $("#alertPlay").val();
					taggingCombosJugadaNoProcesada("Error :: Gana Diario", alertPlay);
