...
@Entity
@NamedNativeQuery(name = "BALANCESALE_GETBONUSLIST", query = "{ call LOTOCARD.BALANCESALE.GETBONUSLIST(?,?) }", callable = true, resultClass = ClientProcedureGetTeApuestoBonusList.class)
public class ClientProcedureGetTeApuestoBonusList {
