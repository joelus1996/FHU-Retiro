...
@Entity
@NamedNativeQuery(
		name = "PRIZE_PAYMENT_CREATE_REQUEST_TRANS_AUTOMATIC",
		query = "{ call LOTOCARD.PRIZE_PAYMENT.CREATE_REQUEST_TRANS_AUTOMATIC(?,?,?,?,?,?,?,?,?,?,?,?,?) }",
		callable = true,
		resultClass = PaymentPrizeProcedureCreateRequestTransAutomatic.class
		)
public class PaymentPrizeProcedureCreateRequestTransAutomatic {
