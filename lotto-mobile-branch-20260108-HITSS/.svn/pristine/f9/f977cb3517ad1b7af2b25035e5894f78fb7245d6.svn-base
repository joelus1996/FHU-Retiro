! function(e, t) {
    ...
    function documentValidation(rtn){
    	...
    	if(rtn.attr('id')=='documento-pasap'){
        	if(rtn.attr('class')=='error'){
        		$('#documento_pasap_msg').hide();
        	}else{
        		
        		$('#documento_pasap_msg').show();
        	}                	
        }
    	if(rtn.attr('id')=='documento-carex'){
        	if(rtn.attr('class')=='error'){
        		$('#documento_carex_msg').hide();
        	}else{
...
//	    		$('#numberDoc_msg').show();
//	    	}
//        	if($('#documento-pasap').attr('class')=='error'){
//        		$('#documento_pasap_msg').hide();
//        	}else{
...
//        		$('#documento_pasap_msg').show();
//        	}
//        	if($('#documento-carex').attr('class')=='error'){
//        		$('#documento_carex_msg').hide();
//        	}else{
