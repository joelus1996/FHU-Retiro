...
<head>
	...
	<link media="screen" rel="stylesheet" type="text/css" href="layer-view-style/game/casino/themeCasino.css?v=1">
	...
	<script src="layer-view-script/game/videoloteria/font-awesome.js"></script>
<style>
			...
			<div class="content">
				<section class="main-section">
					<div class="main-game-casino">
						<!--figure style="width: 100%; aspect-ratio: 535 / 259; border-radius: 11px; overflow: hidden;">
						    <img 
						      src="layer-view-image/v2/header_lobby_video_loterias1.png" 
						      alt="" 
						      style="width: 100%; height: 100%; object-fit: cover;" 
						    />
						  </figure-->
						<iframe id="myIframe" class="bannerMobile" src="<%= Constantes.iframeHomeBannerVideoLoteriaURL %>" frameborder="0" scrolling="no" style="overflow: hidden;width: 100%;"><p>Is imposible, your browser dont support iframe</p></iframe>					
					</div>
							 ...
							 <div>					 							 
								...
								<div id="games">
	    								<div id="todos" style="display:block;">
											<jsp:include page="include-videoloteria-todos.jsp" />											
										</div>	
										<div class="modals">
...
<script type='text/javascript' src='layer-view-script/game/videoloteria/lotto-videoloteria.js?v=4'></script>
