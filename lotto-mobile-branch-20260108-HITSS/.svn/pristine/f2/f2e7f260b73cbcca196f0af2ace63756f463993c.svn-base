...
<head>
	...
	<title>Resultados de La Tinka | Últimos Resultados de Hoy</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<link rel="stylesheet" href="layer-view-style/v2/styles.css?v=<%=Constantes.styles_css%>" type="text/css" />
	<meta name="description" content="Descubre los últimos resultados de sorteos anteriores de La Tinka de forma online. ¡Entra ahora y descubre si fuiste uno de los ganadores!" />
</head>
...
<body class="main-tinka">
	...
	<h1 style="display: none;">Resultados de La Tinka</h1>
						...
						<div class="boxes-lots">
					      	<c:forEach	var="item"  items="${getListResult}">
								<div class="box-last-game">
									...
									<c:if test="${!empty item.extra2 }">
										<div class="bottom-last-game">
											<h5>Sí o Sí: ${item.extra2}</h5>
										</div>
									</c:if>
