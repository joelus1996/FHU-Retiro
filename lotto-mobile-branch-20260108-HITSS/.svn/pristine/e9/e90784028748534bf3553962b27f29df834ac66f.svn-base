		...
		if(data.status=="OK"){
			if(JSON.parse(data.listaNotificaciones).length>0){
				...
				$.each(JSON.parse(data.listaNotificaciones), function( key,value ) {
					if(value.flag=="0"){
						htmlNotificaciones+='<div class="item" style="margin-top: 20px; margin-bottom: 5px; border: 1px solid #53c1a9; border-radius: 5px; box-shadow: 0 0 5px #53c1a9; padding: 10px;">';
					}else{
						htmlNotificaciones+='<div class="item" style="margin-top: 20px; margin-bottom: 5px; border: 1px solid #53c1a9; border-radius: 5px; padding: 10px;">';
					}
					...
					if(value.type==1){
						...
						htmlNotificaciones+='<span style="font-size: 11px; color: grey;">' + value.insertDate + '</span><br>';
						htmlNotificaciones+='</p>';
						//htmlNotificaciones+='<a onclick="redirige(\'client_price_show_information.html?redirige=premios\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; margin-left: 20px; font-size: 13px;">Cobrar premios ></a>';
						//htmlNotificaciones+='<a onclick="redirige(\'client_play_show_information.html\',\''+value.id+'\')" style="position: absolute; right: 32px; color: #00d4f8; text-decoration: underline; font-size: 13px; margin-top: 3px;">Ir a mis jugadas ></a>';
						htmlNotificaciones+='<a onclick="redirige(\'client_balance_show_information.html\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: left; width: 49%; display: inline-block;padding-left: 20px;">Ir a Mis Movimientos ></a>';
						htmlNotificaciones+='<a onclick="redirige(\'client_price_show_information.html?redirige=premios\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: right; width: 50%; display: inline-block; ">Retirar Premios ></a>';
						...
						//htmlNotificaciones+='<a onclick="redirige(\'client_price_show_information.html?redirige=premios\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; margin-left: 20px; font-size: 13px;">Cobrar premios ></a>';
						//htmlNotificaciones+='<a onclick="redirige(\'client_play_show_information.html\',\''+value.id+'\')" style="position: absolute; right: 32px; color: #00d4f8; text-decoration: underline; font-size: 13px; margin-top: 3px;">Ir a mis jugadas ></a>';
						htmlNotificaciones+='<a onclick="redirige(\'client_price_show_information.html?redirige=premios\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: left; width: 49%; display: inline-block; padding-left: 20px;">Cobrar premios ></a>';
						htmlNotificaciones+='<a onclick="redirige(\'client_play_show_information.html\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: right; width: 50%; display: inline-block;">Ir a mis jugadas ></a>';
						...
						htmlNotificaciones+='</p>';
						//htmlNotificaciones+='<a onclick="redirige(\'client_price_show_information.html?redirige=historial\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; margin-left: 20px; font-size: 13px;">Ir a historial de retiros ></a>';
						htmlNotificaciones+='<a onclick="redirige(\'client_price_show_information.html?redirige=historial\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: left; width: 99%; display: inline-block; padding-left: 20px;">Ir a historial de retiros ></a>';
						...
						htmlNotificaciones+='</p>';
//						htmlNotificaciones+='<a onclick="redirige(\'client_edit_password.html\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: left; width: 100%; display: inline-block; padding-left: 20px;">Ir a Mi Perfil ></a>';
						htmlNotificaciones+='<a onclick="redirige(\'client_edit_password.html\',\''+value.id+'\')" style="color: #00d4f8; text-decoration: underline; font-size: 13px; text-align: right; width: 99%; display: inline-block;">Ir a Mi Perfil ></a>';
					}
					htmlNotificaciones+='</div>';
				});
			}else{
				$("#pagination-items-hispayment").css("display","none");
				htmlNotificaciones+='<br><div style="text-align: center;"><h2>Aún no tienes<br>notificaciones</h2></div><div style="text-align: center;"><img class="nofound__img" src="layer-view-image/client/no-retiros.svg"></div>';
			}
		}
