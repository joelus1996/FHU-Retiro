...
@Entity
@NamedNativeQuery(
		name = "GANADIARIOSALE_BET_DATA", 
		query = "{ call LOTOCARD.LOTTOMOBILE.BET_DATA_GANADIARIO_2(?,?) }", 
		callable = true, 
		resultClass = GanadiarioSale.class)
public class GanadiarioSale {
	...
	public Map<String, String> toMap(){
		...
		map.put("pozo", ((prize!=null && !prize.equals("") && !prize.equals("0"))?prize:""));
	...
	public String toString(){
		return " status:"+status+" message:"+message+" prize:"+prize+" activeDraw:"+activeDraw+" closeDate:"+closeDate
				...
				+" fourthMonths:"+fourthMonths+" fourthDiscount:"+fourthDiscount+" fourthDraws:"+fourthDraws+" drwid:"+drwid
