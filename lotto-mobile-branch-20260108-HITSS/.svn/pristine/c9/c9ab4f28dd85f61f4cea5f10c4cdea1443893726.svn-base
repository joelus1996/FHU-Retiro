...
@Entity
@NamedNativeQuery(
		name = "GANAGOLSALE_BETDATA_MOBILE", 
		query = "{ call LOTOCARD.GANAGOLSALE.BET_DATA_MOBILE(?,?) }", 
		callable = true, 
		resultClass = GanagolProcedureBetDataMobile.class)
public class GanagolProcedureBetDataMobile {
