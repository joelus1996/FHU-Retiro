...
public interface PaymentPrizeBo {
	...
	public PaymentPrizeProcedureCreateRequestVisa createRequestVisa(String clientId, Double amount, String ip, String paymentType, String plataform, String cardToken, String cardNumber, String transactionId,
	...
	public PaymentPrizeProcedureCreateRequestTrans createRequestTransPML(String string, Double amountTransferencia,
			String ip, String paymentType, String plataform, String imgDNITransferencia, String loadedImage,
