...
<!-- End Google Tag Manager -->
	...
	<title>La Tinka : Informaci?n</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<script type="application/javascript" charset="UTF-8" src="https://cdn.agentbot.net/core/884b3b863bff3aaba366eb174010cc1d.js"></script>
	...
	<meta name='description' content="La Tinka m?vil, registra un nuevo cliente" />
	
</head>

<body class="iframe-content-wordpress">
	...
	<div class="container content content-wrap">
		<iframe id="iframeWP" src="<%=Constantes.URL_QW%>/persona-politicamente-expuesta/"></iframe>
	</div>
