...
<head>
	...
	<link media="screen" rel="stylesheet" type="text/css" href="layer-view-style/client/mainCollectPrize_ta.css?v=48">	
	...
	<div class="ioverlay modal-msg" id="modal-msg-error">
	 ...
	 <div class="ioverlay modal-msg" id="modal-msg-info">
      ...
      <div class="ioverlay" id="modal-success">
        <div class="modal is-success">
          <div class="modal__close iclose"><span class="icon-cerrar icon-cerrar-token" style="display: none;"></span></div>
                ...
                <div class="top-right-saldo">
					...
					<div class="saldo-add">
					  ...
					  <div class="saldo-item">
					    <!-- Icono SVG Saldo (usa currentColor para heredar color por CSS) -->
					    <svg class="icon-svg" width="26" height="26" viewBox="0 0 26 26" aria-hidden="true">
					      <path d="M10.3 5.2c0-1.1.9-2 2-2h1.4c1.1 0 2 .9 2 2v0.4c0 .7-.4 1.3-1 1.7l-.9.5h-1.6l-.9-.5c-.6-.4-1-.9-1-1.7V5.2z"
					            fill="currentColor"/>
					      <path d="M5 10.5c2.7-1.2 6-1.9 8-1.9s5.3.7 8 1.9c1.5.7 2.5 2.2 2.5 3.9 0 4.2-4.7 7.6-10.5 7.6S2.5 18.6 2.5 14.4c0-1.7 1-3.2 2.5-3.9z"
					            stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
					      <path d="M9 15.9c1.2.7 2.7 1.1 4 1.1s2.8-.4 4-1.1" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
					    </svg>
					
					    <div class="saldo-text">
					      <span class="saldo-label">Saldo:</span>
					      <strong id="balanceAmount" class="saldo-amount">0</strong>
					      <!-- (Opcional) tercera línea pequeña -->
					  ...
					  <div class="saldo-item disponible-item">
					    <!-- Icono SVG Disponible -->
					    <svg class="icon-svg" width="26" height="26" viewBox="0 0 26 26" aria-hidden="true">
					      <g fill="currentColor">
					        <rect x="3" y="7" width="20" height="12" rx="2"/>
					        <rect x="8" y="10" width="10" height="6" rx="1" fill="rgba(0,0,0,0.2)"/>
                              ...
                              <div id="step" class="step"><i  id="stepUnoEfectivo">1</i>
	                              <div class="form-item" id="divMontoEfectivo">
	                                ...
	                                <div class="input">
	                                  ...
	                                  <input class="is-numeric" type="text" name="iamount" maxlength="10" id="amountEfectivo"  data-min="0" data-max="0" data-valid="amount">
	                                </div>
...
<!--                               <div class="steps-title">Pasos a seguir:</div> -->
                              ...
                              <div class="step"><i>1</i>Ingresa el monto a retirar
                                <div class="form-item ispad15" id="divMontoAgora">
                                  <div class="input">
                                    <label>Monto en S/</label>
                                    <input class="is-numeric" type="text" name="iamount" maxlength="10" id="amountAgora" data-min="0" data-max="0" data-valid="amount">
                                  </div>
...
<!-- 										  <input class="is-numeric" type="tel" name="iamount" maxlength="10" id="amountTransferencia"  data-min="0" data-max="0" data-valid="amount"/> -->
										  	...
										  	<input class="is-numeric" type="text" name="iamount" maxlength="10" id="amountTransferencia" data-valid="amount" />
										</div>
...
<!-- 		                                	<button type="button" id="consultResultKyc3" class = "btn-verificar" >Verificar</button> -->
					...
					<div id="tab-historial" class="tab-content">
					  <div class="footlinks">
					    <!-- aquí solo contenido, NO tab-btn -->
					  </div>
					
					  <div id="sin-retiros" style="display:none;">
					    Aún no has hecho ningún retiro
					  </div>
                  ...
                  <div class="accordion__body">
                    <div class="inner">
                      ...
                      <div class="record__content" style="border: 1px solid #E2E2E2; margin-top: 18px; padding-top: 0px;">               	
                      	<div>
                      		<div class="inner" style="padding-top: 7px; padding-right: 0px; padding-left: 0px; width: 100%;">	
...
<!-- 		                                	<button type="button" id="consultResultKyc3" class = "btn-verificar" >Verificar</button> -->
    ...
    <div class="ioverlay" id="modal-ticket3">
        <div class="modal is-ticket">
		 ...
		 <div class="back" 	style="max-width: 712px; margin: 0px;"><a href="#" id="volverModalRetirosDebitIdQR" onclick="volverModalRetirosDebitIdQR()">Volver a retiros</a></div>
		<div class="content_loading"> 
          ...
          <div class="modal__footer">
            <form class="form frm-newsletterDebitIdQR" action="downloadTicketsPPDebitIdQR.html" method="post" name="formDownloadDebitIdQR" id="formDownloadDebitIdQR">
              ...
              <span class="down is-cian no-underline" style="margin-right: 0px;"><span onclick="downloadTicketsPPDebitIdQR()">Descargar</span></span>
...
<script type="text/javascript" src="layer-view-script/client/mainCollectPrize_ta.js?v=124" charset="UTF-8"></script>
