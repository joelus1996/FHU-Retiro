						...
						<div class="modal__boby" style="padding-bottom: 20px;">
							<div>
								...
								<p style='text-align: left; line-height: 12px;'>
									<br><span style="font-size: 10px;">Para que tu retiro sea aprobado, t� debes ser el
										titular de la cuenta y los datos de tu cuenta de La Tinka deben ser iguales a
										los de tu cuenta bancaria. Caso contrario, tu retiro ser� rechazado.</span><br>
								</p>
								<div id="divRecurrencia">
									...
									<div class="form__check">
										...
										<label for="recurrenteTra" style="color: #086c46;font-size: 11px;">Guardar
											n�mero de cuenta como recurrente</label>
									</div>
									<hr>
								</div>
							</div>
							...
							<p style="margin-top: 20px; margin-bottom: 0px; font-size: 11px; text-align: justify;">
								Algunos bancos cobran una comisi�n interplaza del 0.05% del monto retirado, o un m�nimo
								de S/7.50. Si quieres actualizar tu nombre, apellidos o DNI,
								<a href="derechos-arco.html" target="_blank"
									style="text-decoration: underline; color: #e30613;">solic�talo aqu�</a>
							</p>
						</div>
					</div>
				</div>
												...
												<div class="method-cards" aria-label="M�todo de cobro">
													...
													<button type="button" class="method-card"
														...
														<img class="method-card__icon"
															...
															alt="" aria-hidden="true" />
														<span class="method-card__text">
															<span class="method-card__title">Tarjeta de cr�dito /
																d�bito</span>
															<span class="method-card__subtitle"
												...
												<ul class="accordion is-method listaMetodosRetiro">
													...
													<li class="accordion__item" id="accordion_efectivo"
														...
														<h2 class="accordion__title major-356"><span
															...
															<span class="info" id="rangoMontosEfectivo"></span>
														</h2>
                                ...
                                -->
													...
													<li class="accordion__item" id="accordion_transferencia"
														...
														<h2 class="accordion__title"><span
															...
															<br>Bancaria <span class="info"
																id="rangoMontosTransferencia"></span>
														</h2>
														<div class="accordion__body">
															<div class="inner"
											...
											<div id="tab-historial" class="tab-content">
												<div class="ta-historial">
													<div class="ta-historial__filters"
														aria-label="Filtros de historial de retiros">
														<button type="button" class="ta-chip ta-chip--active"
															data-ta-chip="lastWeek" aria-pressed="true">&Uacute;ltima
															semana</button>
														<button type="button" class="ta-chip ta-chip--search"
															id="taHistSearchBtn" data-ta-chip="search"
															aria-pressed="false">Fecha y/o Tipo de
															b&uacute;squeda</button>
														<!-- 1.35 Inicio Jhon Conopuma - 2026-03-13 - Mostrar filas en la misma fila de filtros (maqueta): no tapa el botón de búsqueda al desplegar -->
														<label class="ta-rows ta-rows--filters">
															<span class="ta-rows__label">Mostrar filas</span>
															<select id="taHistRows">
																<!-- 1.31 Inicio Jhon Conopuma - 2026-03-13 - Mostrar filas: opciones 15/20/25/50/100 (el listado+paginación se adaptan vía JS) -->
																<option value="15" selected>15</option>
																<option value="20">20</option>
																<option value="25">25</option>
																<option value="50">50</option>
																<option value="100">100</option>
																<!-- 1.31 Fin Jhon Conopuma -->
															</select>
														</label>
														<!-- 1.35 Fin Jhon Conopuma -->
													</div>
