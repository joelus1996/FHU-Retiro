						...
						<div class="modal__boby" style="padding-bottom: 20px;">
							<div>
								...
								<p style='text-align: left; line-height: 12px;'>
									<br><span style="font-size: 10px;">Para que tu retiro sea aprobado, tï¿½ debes ser el
										titular de la cuenta y los datos de tu cuenta de La Tinka deben ser iguales a
										los de tu cuenta bancaria. Caso contrario, tu retiro serï¿½ rechazado.</span><br>
								</p>
								<div id="divRecurrencia">
									<hr>
									<div class="form__check">
										<input type="checkbox" name="recurrenteTra" id="recurrenteTra" value="Y"
											style="position: absolute; opacity: 0;">
										<label for="recurrenteTra" style="color: #086c46;font-size: 11px;">Guardar
											nï¿½mero de cuenta como recurrente</label>
									</div>
									<hr>
								</div>
							</div>
							<button class="btn" id="aceptar-confirmar-retiro-transferencia"
								onclick="continuarRetiroTransferenciaPin()"
								style="background: #07663a; margin: 20px auto 0;">Confirmar retiro</button>
							<button class="btn"
								style="margin-top: 12px; background: #ffffff; border: 2px solid #07663a; color: #77736f;"
								id="regresar-transferencia" onclick="regresarRetiroTransferencia()">REGRESAR</button>
							<p style="margin-top: 20px; margin-bottom: 0px; font-size: 11px; text-align: justify;">
								Algunos bancos cobran una comisiï¿½n interplaza del 0.05% del monto retirado, o un mï¿½nimo
								de S/7.50. Si quieres actualizar tu nombre, apellidos o DNI,
								<a href="derechos-arco.html" target="_blank"
									style="text-decoration: underline; color: #e30613;">solicï¿½talo aquï¿½</a>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="ioverlay modal-msg" id="modal-confirmar-retiro-transferencia-pin">
					<div class="modal is-error" style="width: 97%;  max-width: 433px;margin: 0 auto; ">
						...
						<div class="modal__boby" style="padding: 20px 10%;">
							...
							<p style="margin-top: 20px; margin-bottom: 0px; font-size: 11px; text-align: center;">ï¿½No
								recibiste tu cï¿½digo?
							</p>
							<p style="margin-top: 10px;margin-bottom: 0px;font-size: 11px;text-align: center;">
								<a id="btnReenvioCodeEmail"
									...
									href="javascript:reenviarRetiroTransferenciaPinCorreo();">Reenviar cï¿½digo por
									Email</a>
								<a id="btnReenvioCodeSMS"
									style="display: block;text-decoration: underline;color: #e30613;margin-top: 8px;"
									href="javascript:reenviarRetiroTransferenciaPinSms();">Reenviar cï¿½digo por SMS</a>
							</p>
						</div>
					</div>
				</div>
					...
					<div class="modal is-error">
						<div class="modal__boby" style="padding-left: 25px; padding-right: 25px;">
							<div>
								...
								<!--           	</p> -->
								<p style='text-align: center;'><span style='font-size: 16px; font-weight: 700;'>ï¿½Cobra
								...
								<p style='text-align: center;margin-bottom: 8px;'>o enviando los datos de tu tarjeta
									dï¿½bito VISA asociado a esa cuenta.</p>
								<button class="btn" style="margin-top: 8px; background: #07663a;" id="aceptar-ir-visa"
									onclick="irVisa()">IR A VISA</button>
								<br>
								<p style='text-align: center; font-weight: 700;margin-bottom: 8px;'>ï¿½Aï¿½n deseas retirar
									en efectivo?</p>
										...
										<div class="saldo-add">
											...
											<div class="saldo-item">
												...
												<div class="saldo-text">
													...
													<!-- (Opcional) tercera lï¿½nea pequeï¿½a -->
									...
									<li class="accordion__item opened is-modal">
										<div id="bodyPrincipal" class="accordion__body content_loading">
											<div id="tab-retiro" class="tab-content active">
												...
												<div class="method-cards" aria-label="Mï¿½todo de cobro">
												...
												<ul class="accordion is-method listaMetodosRetiro">
													...
													<li class="accordion__item" id="accordion_efectivo"
														...
														<h2 class="accordion__title major-356"><span
															...
															<span class="info" id="rangoMontosEfectivo"></span></h2>
														<h2 class="accordion__title minor-356"
															...
															venta <span class="info"
																id="rangoMontosEfectivo-356"></span></h2>
															...
															<div class="inner">
																<form class="metodo-efectivo steps" autocomplete="off"
																	...
																	<div id="divStepDNIEfectivo" class="step hidden">
																		...
																		<div class="fileup-image"
																			...
																			<span id="stateDniPENEfectivo"
																				...
																				por ï¿½nica vez, adjuntando el lado que
																			...
																			<div class="filenames empty"
																				id="filenamesDniEfectivo"><span
																					class="filename-empty">No se adjuntï¿½
																					ninguna imagen</span>
																	...
																	<div class="step hidden" id="stepKYCEfectivo"><i
																		...
																		por ï¿½nica vez cada 36 meses, si tus datos son
																		correctos.
																		<div class="form_visa" id="divEfectivoKYC">
																			...
																			<span class="form_visa_card_mask hidden"
																				...
																				<span id="efectivoSDKBtn"
																					...
																					class="verificarKYC"><u>Clic aquï¿½
																		...
																		<div
																			...
																			Deberï¿½s permitir el acceso a tu cï¿½mara para
																			realizar la verificaciï¿½n.</div>

																	</div>
																	<div class="step"
																		style="margin-top: 5px; font-size: 11px; ">
																		Podrï¿½s cobrar tu retiro ï¿½nicamente en efectivo,
													...
													<li class="accordion__item" id="accordion_visa"
														...
														<h2 class="accordion__title major-356"><span
																...
																id="rangoMontosVisa"></span></h2>
														<h2 class="accordion__title minor-356"
															style="height: 21px !important;"><span
																class="icon-tarjeta"></span>Visa <span class="info"
																id="rangoMontosVisa-356"></span></h2>
														<div class="accordion__body">
																...
																<form class="metodo-visa steps" autocomplete="off"
																	...
																	<div>
																		<p style="font-size: 12px;">Retira entre S/
																			...
																			transacciones diarias.<br>Retiro mï¿½ximo
																			semanal S/ <span
																				id="maxAmountPerWeekVisa"></span>.</p>
																	</div>
																	...
																	<div class="step"
																		...
																		confirmado tu retiro se harï¿½ el abono a tu
																		tarjeta en menos de 30 minutos. Si tienes
																		tarjeta de crï¿½dito, esto puede tomar 2 dï¿½as
																		adicionales.</div>
                                ...
                                <div class="fileup-image" id="divImgDniAgora">
                                  ...
                                  <div class="filenames empty" id="filenamesDniAgora"><span class="filename-empty">No se adjuntï¿½ ninguna imagen</span>
                                    <div class="filename-simple"></div>
																	...
																	<div class="step"><i
																			id="stepCardAgora">2</i>Selecciona o aï¿½ade
																		tu tarjeta
                                ...
                                -->
																	...
																	<div class="step"><i id="stepCardSDKAgora">3</i>
																		...
																		<div style="margin-top: 5px;">Una vez confirmado
																			tu retiro se harï¿½ el abono a tu tarjeta en
													...
													<li class="accordion__item" id="accordion_transferencia"
														style="display: none;">
														<h2 class="accordion__title"><span
																class="icon-transferencia"></span>Transferencia
															<br>Bancaria <span class="info"
																id="rangoMontosTransferencia"></span></h2>
														<div class="accordion__body">
															<div class="inner"
																...
																<form class="metodo-transferencia steps"
																	...
																	<div class="step" id="stepCuentaTransferencia"><i
																		...
																		<div class="form-item ispad15"
																			...
																			<div class="input__error">INGRESA UN Nï¿½MERO
																	...
																	<div id="divStepDNITransferencia"
																		...
																		<div class="fileup-image"
																			...
																			<span id="stateDniPENTransferencia"
																				...
																				ï¿½nica vez, la foto de tu DNI por el lado
																	...
																	<div class="step hidden" id="stepKYCTrans"><i
																		...
																		tus datos por ï¿½nica vez cada 36 meses, si tus
																		datos son correctos.
														...
														<div class="inner"
															...
															<div
																...
																<p style="padding-right: 6.66667%;padding-left: 6.66667%;"
																	...
																	representante de La Tinka se contactarï¿½ contigo para
																	coordinar tu pago que se realizarï¿½ en un plazo
																	mï¿½ximo de 30 dï¿½as</p>
															</div>
															<form class="metodo-transferencia steps" autocomplete="off"
																...
																<div class="step" id="stepCuentaTransferenciaPML"><i
																	...
																	<div class="form-item ispad15"
																		...
																		<div class="input__error">INGRESA UN Nï¿½MERO DE
																			CUENTA CORRECTO</div>
																	</div>
																</div>
																...
																<div id="divStepDNITransferenciaPML"
																	...
																	<div class="fileup-image"
																		...
																		<span id="stateDniPENTransferenciaPML"
																			style="display: none;">Adjunta, por ï¿½nica
																...
																<div id="divStepSDKPML" class="step hidden"><i
																	...
																	ï¿½nica vez cada 36 meses, si tus datos son correctos.
																	<div class="form_visa" id="divPMKYC">
																		...
																		<span class="form_visa_card_mask hidden"
																			...
																			<span id="PMSDKBtn" style="cursor: pointer;"
																				class="verificarKYC"><u>Clic aquï¿½ para
																					actualizar</u></span>
																		</span>
																		<!-- 		                                	<button type="button" id="consultResultKyc3" class = "btn-verificar" >Verificar</button> -->
																	</div>
																...
																<div class="step"
																	style="margin-top: 5px; font-size: 10px; font-weight: 700; ">
																	Asegï¿½rate de ser el titular de la cuenta y que los
																	datos de tu cuenta de La Tinka sean iguales a los de
																	tu cuenta bancaria. Caso contrario, tu retiro serï¿½
																	rechazado.</div>
										...
										<div class="accordion__body">
											<div class="inner">
												...
												<div class="record__content nofound">
													<div class="nofound__title">Aï¿½n no has hecho <br>ningï¿½n retiro</div>
																	...
																	<div class="form-item">
																		<div class="select">
																			...
																			<select class="bydate" name="name"
																				...
																				<option value="2">La ï¿½ltima semana
																				</option>
																				<option value="3">El ï¿½ltimo mes</option>
																				<option value="4">Rango especï¿½fico
																				</option>
																			</select>
																		</div>
																	</div>
