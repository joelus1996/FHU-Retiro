...
<!-- End Google Tag Manager -->
	...
	<title>La Tinka : Mis Jugadas</title>
		...
		<div class="content-wrap">
			<div class="content">
				<section class="main-section" style="background-color: #fbe601;">	
					<div class="main-page" id="game-title-total-main-page">
				...
				<iframe id="iframeContent" src="client_play_information_api.html?authToken=${token}" scrolling="no" frameborder="0" class="game-iframe"> 
				</iframe>
			</div>
		</div>
	</div>
