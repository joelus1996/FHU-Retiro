...
<head>
	...
	<link media="screen" rel="stylesheet" type="text/css" href="layer-view-style/client/mainCollectPrize.css?v=32">	
...
<script type="text/javascript" src="layer-view-script/client/mainCollectPrize.js?v=124" charset="UTF-8"></script>
