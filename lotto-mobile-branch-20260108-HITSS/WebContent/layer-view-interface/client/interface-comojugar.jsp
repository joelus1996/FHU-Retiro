...
<!-- End Google Tag Manager -->
	...
	<meta name='description' content="La Tinka móvil, cómo jugar en un punto de venta" />
...
<body class="iframe-content-wordpress">
	...
	<div class="container content content-wrap">
		<iframe id="iframeWP" src="<%=Constantes.URL_QW%>/como-jugar/en-punto-de-venta/"></iframe>
