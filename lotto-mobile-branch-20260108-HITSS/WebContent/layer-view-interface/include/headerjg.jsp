...
<header id="header">
	...
	<div class="sub-header">
		<c:if test="${!empty clientId && agreement!=''}">
			<div class="cont-header user-data"  style="padding: .2em 1.0em;">
				<div class="text-header text-name"><b>${username}</b></div>
				<div class="text-header text-money">Saldo: <span id="clientSale-amount">${saldo}</span></div>
				<div class="text-header text-money">Bono Te Apuesto: <span id="billetera2-amount">${bonoTeApuesto}</span></div>
				<div class="text-header text-money">Jugadas gratis: <span>${bonoOtro}</span></div>
			</div>
		</c:if>
<!-- 		<div class="cont-header"> -->
<!-- 			<a href="#" onclick="window.location.href = 'home.html';"> -->
<!-- 				<img src="layer-view-image/v2/home.svg" alt="" /> -->
<!-- 			</a> -->
<!-- 		</div>	 -->
		...
		<div class="cont-header">
			<a id="open-button" style="padding: 9px 0px;padding-right:1px;">
					<img src="layer-view-image/v2/menu.svg" alt="" style="height: 25px;" />	
			</a>
		</div>
...
<input type="hidden" value="${sessionScope.tipoBoletoSuscripcion}" id="tipoBoletoSuscripcion">
	...
	<nav class="menu">
		<div class="icon-list">
			...
			<c:if test="${empty clientId or agreement==''}">
				<a href="#" id="btn_mobile_ingresar">
					<span class="icon-list-item">Login</span>
				</a>
			</c:if>
			...
			<c:if test="${!empty clientId && agreement!=''}">
				<a href="#" id="client_lotocard_show_information" style="background-color: #e00909;">
					<span class="icon-list-item">Cargar Saldo</span>
				</a>
				<a href="#" id="client_balance_bono_te_apuesto_show_information">
					<span class="icon-list-item">Bono Te Apuesto</span>
				</a>
				<a href="#" id="client_balance_bono_games_show_information">
					<span class="icon-list-item">Jugadas gratis</span>
				</a>
				<a href="#" id="client_price_show_information">
					<span class="icon-list-item">Mis premios</span>
				</a>
				<a href="#" id="client_play_show_information">
					<span class="icon-list-item">Mis jugadas</span>
				</a>
				<a href="#" id="client_balance_show_information">
					<span class="icon-list-item">Mis movimientos</span>
				</a>
				<%-- 
				<c:if test="${not empty promo}">
				<a href="#" id="client_balance_promo_te_apuesto_show_information">
					<span class="icon-list-item">${promoDescription}</span>
				</a>
				</c:if>
				--%>
				<a href="#" id="client_account_show_information">
					<span class="icon-list-item">Mis datos</span>
				</a>				
			</c:if>
			<%-- <a href="#" id="idMenuPoint"><span class="icon-list-item">Puntos de Venta</span></a> --%>
			<!-- >a href="#" id="gamehtml"><span>Juegos</span></a-->
			
			<c:if test="${!empty clientId && agreement!=''}">
				<a href="#" id="security-close-session">
					<span class="icon-list-item">Cerrar Sesión</span>
				</a>
			</c:if>
			
			<c:if test="${empty clientId or agreement==''}">
<!-- 				<a href="#" id="client_lotocard_show_term"> -->
				<a href="#" id="btn_mobile_registrate">
					<span class="icon-list-item">Registrate</span>
				</a>
			</c:if>
			
			<a href="#" id="helphtml"><span class="icon-list-item">Ayuda</span></a>
		</div>
		<br><br><br><br><br><br>
	</nav>
