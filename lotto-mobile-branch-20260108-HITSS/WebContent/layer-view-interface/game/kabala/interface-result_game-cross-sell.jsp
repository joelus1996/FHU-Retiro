...
<div class="row" id=list_cross_kabala>								        
</div>
...
$.ajax({    		  
	...
	success: function(res) {
	  	...
	  	if (data[0]) {  		  		
	  		var paso ="Paso 3";
			try{
				paso = ($("#SubZona").val() == "Combos Kábala") ? 'Paso 4' : 'Paso 3';
			}catch(e){}
	  		  		  	
	  		$(res).find('crossSell').children('crossKabala').each(function(){
	            ...
	            $('#list_cross_kabala').append(itemJuego);
	  	    });	  				  		
	  	} else {
	  		console.log('no data')
	  	}
