...
<body class="main-ganadiario">
	...
	<script type="text/javascript">
		...
		$(document).delegate('#btn_mobile_agregar_boleto_ganadiario', 'click', function() {		
			...
			mainValidatePendingsDocsForAproval('interfaceBetClickwheelAgregarBoletoGanadiario');
		});

		function interfaceBetClickwheelAgregarBoletoGanadiario() {
			if(count<5) {
		...
		window.addEventListener("message", function(event) {
		    if (event.data === "interfaceBetClickwheelAgregarBoletoGanadiario") {
		    	interfaceBetClickwheelAgregarBoletoGanadiario(); 
		    }
		});
