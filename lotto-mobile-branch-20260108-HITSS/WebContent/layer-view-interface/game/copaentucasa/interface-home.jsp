...
<body class="main-copaentucasa">
	...
	<div class="container">	
		...
		<div class="content-wrap">		
			<div class="content">
				<img src="layer-view-image/game/copaentucasa/img-copa-mobile.gif" style="display: block;margin-left: auto;margin-right: auto;width: 100%;">			
				<section class="main-section">										
					<div class="main-game copa-casa">
						<h2>Gana una TV Ultra HD 70",</h2>
						<h3>soundbar, Kit Blanquirrojo y frigobar.<br>Además, miles de soles en saldos y premios.</h3>
						<span class="juega-5">Juega desde S/5</span>							
					
					<div class="copa-opciones">
						
							
								<button type="button" id="btn_mobile_como_participar_copa" onclick="return false;"class="button-copa1">¿Cómo participar?</button>
							
							<c:if test="${!empty clientId}">
								
									<button type="button" id="btn_mobile_ver_jugadas_copa" onclick="return false;"class="button-copa2">Ver mis jugadas</button>
								
							</c:if>
							<c:if test="${empty clientId}">
								
									<button type="button" id="security_login_execute_authentication_copacasa" onclick="return false;"class="button-copa2">Ver mis jugadas</button>
					...
					<div class="copa-descripcion">
						<h3>Del sábado 08 de mayo al domingo 11 de julio</h3>
					</div>
					</div>
				</section>
			</div>
