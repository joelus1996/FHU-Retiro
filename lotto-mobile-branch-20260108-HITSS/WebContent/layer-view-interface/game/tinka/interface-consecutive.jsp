...
<head>
	...
	<title>Tinka : Jugada</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<link rel="stylesheet" href="layer-view-style/v2/styles.css?v=<%=Constantes.styles_css%>" type="text/css" />
	<meta name="description" content="Tinka móvil, realiza una jugada consecutiva" />
	
<%

String jugadasActuales = request.getParameter("jugadasActuales");
...
<body class="main-tinka">
	...
	<input type="hidden" id="precio" value="<%=price%>"/>
			...
			<div class="content">
				<section class="main-section">
					<div class="main-game">
						...
						<form action="game_tinka_add_consecutive.html" method="post" id="game_tinka_add_consecutive">

							<div class="boxes-lots boxes-no-padding">

							    <c:forEach 	var="item"  items="${consecutiveTinkaList_TK}">
							    ...
							    <br>
<!-- 								<button type="button" id="addConsecutiveTinka" class="btn btn-red">CONTINUAR</button><br> -->
							    <button type="button" id="addConsecutiveTinka" class="btn btn-red float-bottom">CONTINUAR</button>
