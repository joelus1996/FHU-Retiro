			...
			<div class="content">		
				...
				<div id="avionQatar-retroceder" class="copacasa-volver" style="background-color: #841144;">
					  <div class="row" style="width: 100%">
						    ...
						    <div class="col-sm-4" style="margin:0px auto"><img style="margin-top: 4px;" class="img-volver" src="layer-view-image/game/teapuesto/avionQatar/logo_taqatar_mobile.png"></div>
				...
				<div>
					<div class="desc-sorteo"><h3 style="font-size: 12px; color: #000000;font-family: AmsiPro-Bold;">SORTEOS 24 DE OCTUBRE Y 21 DE NOVIEMBRE:</h3></div>	
					<img class="responsive-imagenes" style="width: 330px;margin-bottom: 30px;" src="layer-view-image/game/teapuesto/avionQatar/img-banner-mid.png">		
					...
					<div class="desc-sorteo"><h3 style="font-size: 18px; color: #fb5300;font-family: AmsiPro-Bold;margin-bottom: 2px;">¡Son S/ 110,000 en saldos para </h3></div>	
