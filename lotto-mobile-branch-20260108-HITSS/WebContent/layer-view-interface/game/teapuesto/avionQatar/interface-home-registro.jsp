				...
				<section class="main-section">										
					...
					<div class="copa-opciones">
							...
							<c:if test="${!empty clientId}">							
								<div>
									<button style=" color: #ffffff" type="button" id="btnAvionQatarRegistrar" onclick="return false;"class="button-avion-qatar-naranja">Si quiero</button>
								</div><br>
							</c:if>
							<c:if test="${empty clientId}">
								<div>
									<button type="button" id="security_login_execute_authentication_avionQatar" onclick="return false;"class="button-avion-qatar-naranja">Si quiero</button>
								</div><br>
							</c:if>
							<div style="background: #ffffff;" class="f_linea-copabicolor"></div>
							<div>
								<button type="button" id="btnAvionQatarComoParticipar" onclick="return false;"class="button-avion-qatar-blanco">¿Cómo participar?</button>
							</div>
